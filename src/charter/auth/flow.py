...
class OAuth2Flow:
    ...
    async def exchange(
        ...
        *,
        ...
        """
        if not code:
            raise CredentialError("exchange() requires the authorization code from the callback.")
        data: Dict[str, str] = {
        ...
        refresh_token = raw_refresh if isinstance(raw_refresh, str) and raw_refresh else None
