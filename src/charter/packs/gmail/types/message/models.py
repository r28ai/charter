...
class Header(BaseModel):
    ...
    name: str = Field(..., description="The name of the header before the : separator. For example, To.")
    value: str = Field(..., description="The value of the header after the : separator. For example, someuser@example.com.")
