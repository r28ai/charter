...
class AddBandingRequest(BaseModel):
    ...
    banded_range: Optional[BandedRange] = Field(
        default=None, description="The banded range to add. The bandedRangeId field is optional; if one is not set, an id will be randomly generated. (It is an error to specify the ID of a range that already exists.)",
    )
...
class AddChartRequest(BaseModel):
    ...
    chart: Optional[EmbeddedChart] = Field(
        default=None, description="The chart that should be added to the spreadsheet, including the position where it should be placed. The chartId field is optional; if one is not set, an id will be randomly generated. (It is an error to specify the ID of an embedded object that already exists.)",
    )
...
class AddConditionalFormatRuleRequest(BaseModel):
    ...
    index: Optional[int] = Field(
        default=None, description="The zero-based index where the rule should be inserted.",
    )

    rule: Optional[ConditionalFormatRule] = Field(
        default=None, description="The rule to add.",
    )
...
class AddDataSourceRequest(BaseModel):
    ...
    data_source: Optional[DataSource] = Field(
        default=None, description="The data source to add.",
    )
...
class AddDimensionGroupRequest(BaseModel):
    ...
    range: Optional[DimensionRange] = Field(
        default=None, description="The range over which to create a group.",
    )
...
class AddFilterViewRequest(BaseModel):
    ...
    filter: Optional[FilterView] = Field(
        default=None, description="The filter to add. The filterViewId field is optional. If one is not set, an ID will be randomly generated. (It is an error to specify the ID of a filter that already exists.)",
    )
...
class AddNamedRangeRequest(BaseModel):
    ...
    named_range: Optional[NamedRange] = Field(
        default=None, description="The named range to add. The namedRangeId field is optional; if one is not set, an id will be randomly generated. (It is an error to specify the ID of a range that already exists.)",
    )
...
class AddProtectedRangeRequest(BaseModel):
    ...
    protected_range: Optional[ProtectedRange] = Field(
        default=None, description="The protected range to be added. The protectedRangeId field is optional; if one is not set, an id will be randomly generated. (It is an error to specify the ID of a range that already exists.)",
    )
...
class AddSheetRequest(BaseModel):
    ...
    properties: Optional[SheetProperties] = Field(
        default=None, description="The properties the new sheet should have. All properties are optional. The sheetId field is optional; if one is not set, an id will be randomly generated. (It is an error to specify the ID of a sheet that already exists.)",
    )
...
class AddSlicerRequest(BaseModel):
    ...
    slicer: Optional[Slicer] = Field(
        default=None, description="The slicer that should be added to the spreadsheet, including the position where it should be placed. The slicerId field is optional; if one is not set, an id will be randomly generated. (It is an error to specify the ID of a slicer that already exists.)",
    )
...
class AddTableRequest(BaseModel):
    ...
    table: Optional[Table] = Field(
        default=None, description="Required. The table to add.",
    )
...
class AppendCellsRequest(BaseModel):
    ...
    table_id: Optional[str] = Field(
        default=None, description="The ID of the table to append data to. The data will be only appended to the table body. This field also takes precedence over the `sheet_id` field.",
    )

    rows: Optional[List[RowData]] = Field(
        default=None, description="The data to append.",
    )

    sheet_id: Optional[int] = Field(
        default=None, description="The sheet ID to append the data to.",
    )

    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields of CellData that should be updated. At least one field must be specified. The root is the CellData; 'row.values.' should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None
...
class AppendDimensionRequest(BaseModel):
    ...
    """
    sheet_id: Optional[int] = Field(
        default=None, description="The sheet to append rows or columns to.",
    )

    dimension: Optional[Dimension] = Field(
        default=None, description="Whether rows or columns should be appended.",
    )

    length: Optional[int] = Field(
        default=None, description="The number of rows or columns to append.",
    )
...
class AutoFillRequest(BaseModel):
    ...
    range: Optional[GridRange] = Field(
        default=None, description="The range to autofill. This will examine the range and detect the location that has data and automatically fill that data in to the rest of the range.",
    )

    source_and_destination: Optional[SourceAndDestination] = Field(
        default=None, description="The source and destination areas to autofill. This explicitly lists the source of the autofill and where to extend that data.",
    )

    use_alternate_series: Optional[bool] = Field(
        default=None, description="True if we should generate data with the \"alternate\" series. This differs based on the type and amount of source data.",
    )
...
class AutoResizeDimensionsRequest(BaseModel):
    ...
    dimensions: Optional[DimensionRange] = Field(
        default=None, description="The dimensions to automatically resize.",
    )

    data_source_sheet_dimensions: Optional[DataSourceSheetDimensionRange] = Field(
        default=None, description="The dimensions on a data source sheet to automatically resize.",
    )

    @model_validator(mode="after")
    def _exactly_one(self) -> AutoResizeDimensionsRequest:
        provided = [n for n in ('dimensions', 'data_source_sheet_dimensions') if getattr(self, n) is not None]
        if len(provided) != 1:
            raise ValueError(
...
class CancelDataSourceRefreshRequest(BaseModel):
    ...
    is_all: Optional[bool] = Field(
        default=None, description="Cancels all existing data source object refreshes for all data sources in the spreadsheet.",
    )

    references: Optional[DataSourceObjectReferences] = Field(
        default=None, description="References to data source objects whose refreshes are to be cancelled.",
    )

    data_source_id: Optional[str] = Field(
        default=None, description="Reference to a DataSource. If specified, cancels all associated data source object refreshes for this data source.",
    )

    @model_validator(mode="after")
    def _exactly_one(self) -> CancelDataSourceRefreshRequest:
        provided = [n for n in ('references', 'data_source_id', 'is_all') if getattr(self, n) is not None]
        if len(provided) != 1:
            raise ValueError(
...
class ClearBasicFilterRequest(BaseModel):
    ...
    """
    sheet_id: Optional[int] = Field(
        default=None, description="The sheet ID on which the basic filter should be cleared.",
    )
...
class CreateDeveloperMetadataRequest(BaseModel):
    ...
    developer_metadata: Optional[DeveloperMetadata] = Field(
        default=None, description="The developer metadata to create.",
    )
...
class CutPasteRequest(BaseModel):
    ...
    destination: Optional[GridCoordinate] = Field(
        default=None, description="The top-left coordinate where the data should be pasted.",
    )

    paste_type: Optional[PasteType] = Field(
        default=None, description="What kind of data to paste. All the source data will be cut, regardless of what is pasted.",
    )

    source: Optional[GridRange] = Field(
        default=None, description="The source data to cut.",
    )
...
class DataSourceSheetDimensionRange(BaseModel):
    ...
    column_references: Optional[List[DataSourceColumnReference]] = Field(
        default=None, description="The columns on the data source sheet.",
    )

    sheet_id: Optional[int] = Field(
        default=None, description="The ID of the data source sheet the range is on.",
    )
...
class DeleteBandingRequest(BaseModel):
    ...
    banded_range_id: Optional[int] = Field(
        default=None, description="The ID of the banded range to delete.",
    )
...
class DeleteConditionalFormatRuleRequest(BaseModel):
    ...
    """
    sheet_id: Optional[int] = Field(
        default=None, description="The sheet the rule is being deleted from.",
    )

    index: Optional[int] = Field(
        default=None, description="The zero-based index of the rule to be deleted.",
    )
...
class DeleteDataSourceRequest(BaseModel):
    ...
    """
    data_source_id: Optional[str] = Field(
        default=None, description="The ID of the data source to delete.",
    )
...
class DeleteDeveloperMetadataRequest(BaseModel):
    ...
    data_filter: Optional[DataFilter] = Field(
        default=None, description="The data filter describing the criteria used to select which developer metadata entry to delete.",
    )
...
class DeleteDimensionGroupRequest(BaseModel):
    ...
    """
    range: Optional[DimensionRange] = Field(
        default=None, description="The range of the group to be deleted.",
    )
...
class DeleteDimensionRequest(BaseModel):
    ...
    """
    range: Optional[DimensionRange] = Field(
        default=None, description="The dimensions to delete from the sheet.",
    )
...
class DeleteDuplicatesRequest(BaseModel):
    ...
    """
    range: Optional[GridRange] = Field(
        default=None, description="The range to remove duplicates rows from.",
    )

    comparison_columns: Optional[List[DimensionRange]] = Field(
        default=None, description="The columns in the range to analyze for duplicate values. If no columns are selected then all columns are analyzed for duplicates.",
    )
...
class DeleteEmbeddedObjectRequest(BaseModel):
    ...
    object_id: Optional[int] = Field(
        default=None, description="The ID of the embedded object to delete.",
    )
...
class DeleteFilterViewRequest(BaseModel):
    ...
    filter_id: Optional[int] = Field(
        default=None, description="The ID of the filter to delete.",
    )
...
class DeleteNamedRangeRequest(BaseModel):
    ...
    named_range_id: Optional[str] = Field(
        default=None, description="The ID of the named range to delete.",
    )
...
class DeleteProtectedRangeRequest(BaseModel):
    ...
    protected_range_id: Optional[int] = Field(
        default=None, description="The ID of the protected range to delete.",
    )
...
class DeleteRangeRequest(BaseModel):
    ...
    """
    range: Optional[GridRange] = Field(
        default=None, description="The range of cells to delete.",
    )

    shift_dimension: Optional[Dimension] = Field(
        default=None, description="The dimension from which deleted cells will be replaced with. If ROWS, existing cells will be shifted upward to replace the deleted cells. If COLUMNS, existing cells will be shifted left to replace the deleted cells.",
    )
...
class DeleteSheetRequest(BaseModel):
    ...
    """
    sheet_id: Optional[int] = Field(
        default=None, description="The ID of the sheet to delete. If the sheet is of DATA_SOURCE type, the associated DataSource is also deleted.",
    )
...
class DeleteTableRequest(BaseModel):
    ...
    """
    table_id: Optional[str] = Field(
        default=None, description="The ID of the table to delete.",
    )
...
class DuplicateFilterViewRequest(BaseModel):
    ...
    """
    filter_id: Optional[int] = Field(
        default=None, description="The ID of the filter being duplicated.",
    )
...
class DuplicateSheetRequest(BaseModel):
    ...
    insert_sheet_index: Optional[int] = Field(
        default=None, description="The zero-based index where the new sheet should be inserted. The index of all sheets after this are incremented.",
    )

    new_sheet_id: Optional[int] = Field(
        default=None, ge=0, description="If set, the ID of the new sheet. If not set, an ID is chosen. If set, the ID must not conflict with any existing sheet ID. If set, it must be non-negative.",
    )

    new_sheet_name: Optional[str] = Field(
        default=None, description="The name of the new sheet. If empty, a new name is chosen for you.",
    )
...
class FindReplaceRequest(BaseModel):
    ...
    match_case: Optional[bool] = Field(
        default=None, description="True if the search is case sensitive.",
    )

    range: Optional[GridRange] = Field(
        default=None, description="The range to find/replace over.",
    )

    sheet_id: Optional[int] = Field(
        default=None, description="The sheet to find/replace over.",
    )

    find: Optional[str] = Field(
        default=None, description="The value to search.",
    )

    search_by_regex: Optional[bool] = Field(
        default=None, description="True if the find value is a regex. The regular expression and replacement should follow Java regex rules at https://docs.oracle.com/javase/8/docs/api/java/util/regex/Pattern.html. The replacement string is allowed to refer to capturing groups. For example, if one cell has the contents `\"Google Sheets\"` and another has `\"Google Docs\"`, then searching for `\"o.* (.*)\"` with a replacement of `\"$1 Rocks\"` would change the contents of the cells to `\"GSheets Rocks\"` and `\"GDocs Rocks\"` respectively.",
    )

    include_formulas: Optional[bool] = Field(
        default=None, description="True if the search should include cells with formulas. False to skip cells with formulas.",
    )

    replacement: Optional[str] = Field(
        default=None, description="The value to use as the replacement.",
    )

    all_sheets: Optional[bool] = Field(
        default=None, description="True to find/replace over all sheets.",
    )

    match_entire_cell: Optional[bool] = Field(
        default=None, description="True if the find value should match the entire cell.",
    )
...
class InsertDimensionRequest(BaseModel):
    ...
    inherit_from_before: Optional[bool] = Field(
        default=None, description="Whether dimension properties should be extended from the dimensions before or after the newly inserted dimensions. True to inherit from the dimensions before (in which case the start index must be greater than 0), and false to inherit from the dimensions after. For example, if row index 0 has red background and row index 1 has a green background, then inserting 2 rows at index 1 can inherit either the green or red background. If `inheritFromBefore` is true, the two new rows will be red (because the row before the insertion point was red), whereas if `inheritFromBefore` is false, the two new rows will be green (because the row after the insertion point was green).",
    )

    range: Optional[DimensionRange] = Field(
        default=None, description="The dimensions to insert. Both the start and end indexes must be bounded.",
    )
...
class InsertRangeRequest(BaseModel):
    ...
    """
    shift_dimension: Optional[Dimension] = Field(
        default=None, description="The dimension which will be shifted when inserting cells. If ROWS, existing cells will be shifted down. If COLUMNS, existing cells will be shifted right.",
    )

    range: Optional[GridRange] = Field(
        default=None, description="The range to insert new cells into. The range is constrained to the current sheet boundaries.",
    )
...
class MergeCellsRequest(BaseModel):
    ...
    merge_type: Optional[MergeType] = Field(
        default=None, description="How the cells should be merged.",
    )

    range: Optional[GridRange] = Field(
        default=None, description="The range of cells to merge.",
    )
...
class MoveDimensionRequest(BaseModel):
    ...
    source: Optional[DimensionRange] = Field(
        default=None, description="The source dimensions to move.",
    )
...
class PasteDataRequest(BaseModel):
    ...
    data: Optional[str] = Field(
        default=None, description="The data to insert.",
    )

    type: Optional[PasteType] = Field(
        default=None, description="How the data should be pasted.",
    )

    coordinate: Optional[GridCoordinate] = Field(
        default=None, description="The coordinate at which the data should start being inserted.",
    )

    delimiter: Optional[str] = Field(
        default=None, description="The delimiter in the data.",
    )

    html: Optional[bool] = Field(
        default=None, description="True if the data is HTML.",
    )
    ...
    def _exactly_one(self) -> PasteDataRequest:
        ...
        if len(provided) != 1:
            raise ValueError(
                f"Exactly one of 'delimiter', 'html' must be set, found: {provided}"
            )
        return self
...
class RandomizeRangeRequest(BaseModel):
    ...
    """
    range: Optional[GridRange] = Field(
        default=None, description="The range to randomize.",
    )
...
class RefreshDataSourceRequest(BaseModel):
    ...
    """
    references: Optional[DataSourceObjectReferences] = Field(
        default=None, description="References to data source objects to refresh.",
    )

    data_source_id: Optional[str] = Field(
        default=None, description="Reference to a DataSource. If specified, refreshes all associated data source objects for the data source.",
    )

    is_all: Optional[bool] = Field(
        default=None, description="Refreshes all existing data source objects in the spreadsheet.",
    )

    force: Optional[bool] = Field(
        default=None, description="Refreshes the data source objects regardless of the current state. If not set and a referenced data source object was in error state, the refresh will fail immediately.",
    )
...
class RepeatCellRequest(BaseModel):
    ...
    cell: Optional[CellData] = Field(
        default=None, description="The data to write.",
    )

    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields that should be updated. At least one field must be specified. The root `cell` is implied and should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None

    range: Optional[GridRange] = Field(
        default=None, description="The range to repeat the cell in.",
    )
...
class SetBasicFilterRequest(BaseModel):
    ...
    filter: Optional[BasicFilter] = Field(
        default=None, description="The filter to set.",
    )
...
class SetDataValidationRequest(BaseModel):
    ...
    """
    range: Optional[GridRange] = Field(
        default=None, description="The range the data validation rule should apply to.",
    )

    rule: Optional[DataValidationRule] = Field(
        default=None, description="The data validation rule to set on each cell in the range, or empty to clear the data validation in the range.",
    )

    filtered_rows_included: Optional[bool] = Field(
        default=None, description="Optional. If true, the data validation rule will be applied to the filtered rows as well.",
    )
...
class SortRangeRequest(BaseModel):
    ...
    """
    range: Optional[GridRange] = Field(
        default=None, description="The range to sort.",
    )
...
class SourceAndDestination(BaseModel):
    ...
    """
    source: Optional[GridRange] = Field(
        default=None, description="The location of the data to use as the source of the autofill.",
    )

    dimension: Optional[Dimension] = Field(
        default=None, description="The dimension that data should be filled into.",
    )

    fill_length: Optional[int] = Field(
        default=None, description="The number of rows or columns that data should be filled into. Positive numbers expand beyond the last row or last column of the source. Negative numbers expand before the first row or first column of the source.",
    )
...
class TextToColumnsRequest(BaseModel):
    ...
    delimiter_type: Optional[DelimiterType] = Field(
        default=None, description="The delimiter type to use.",
    )

    source: Optional[GridRange] = Field(
        default=None, description="The source data range. This must span exactly one column.",
    )

    delimiter: Optional[str] = Field(
        default=None, description="The delimiter to use. Used only if delimiterType is CUSTOM.",
    )
...
class TrimWhitespaceRequest(BaseModel):
    ...
    """
    range: Optional[GridRange] = Field(
        default=None, description="The range whose cells to trim.",
    )
...
class UnmergeCellsRequest(BaseModel):
    ...
    """
    range: Optional[GridRange] = Field(
        default=None, description="The range within which all cells should be unmerged. If the range spans multiple merges, all will be unmerged. The range must not partially span any merge.",
    )
...
class UpdateBandingRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields that should be updated. At least one field must be specified. The root `bandedRange` is implied and should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None

    banded_range: Optional[BandedRange] = Field(
        default=None, description="The banded range to update with the new properties.",
    )
...
class UpdateBordersRequest(BaseModel):
    ...
    right: Optional[Border] = Field(
        default=None, description="The border to put at the right of the range.",
    )

    left: Optional[Border] = Field(
        default=None, description="The border to put at the left of the range.",
    )

    range: Optional[GridRange] = Field(
        default=None, description="The range whose borders should be updated.",
    )

    inner_vertical: Optional[Border] = Field(
        default=None, description="The vertical border to put within the range.",
    )

    bottom: Optional[Border] = Field(
        default=None, description="The border to put at the bottom of the range.",
    )

    inner_horizontal: Optional[Border] = Field(
        default=None, description="The horizontal border to put within the range.",
    )

    top: Optional[Border] = Field(
        default=None, description="The border to put at the top of the range.",
    )
...
class UpdateCellsRequest(BaseModel):
    ...
    start: Optional[GridCoordinate] = Field(
        default=None, description="The coordinate to start writing data at. Any number of rows and columns (including a different number of columns per row) may be written.",
    )

    range: Optional[GridRange] = Field(
        default=None, description="The range to write data to. If the data in rows does not cover the entire requested range, the fields matching those set in fields will be cleared.",
    )
    ...
    def _exactly_one(self) -> UpdateCellsRequest:
        ...
        if len(provided) != 1:
            raise ValueError(
                f"Exactly one of 'start', 'range' must be set, found: {provided}"
            )
        return self
...
class UpdateChartSpecRequest(BaseModel):
    ...
    chart_id: Optional[int] = Field(
        default=None, description="The ID of the chart to update.",
    )

    spec: Optional[ChartSpec] = Field(
        default=None, description="The specification to apply to the chart.",
    )
...
class UpdateConditionalFormatRuleRequest(BaseModel):
    ...
    new_index: Optional[int] = Field(
        default=None, description="The zero-based new index the rule should end up at.",
    )

    rule: Optional[ConditionalFormatRule] = Field(
        default=None, description="The rule that should replace the rule at the given index.",
    )

    sheet_id: Optional[int] = Field(
        default=None, description="The sheet of the rule to move. Required if new_index is set, unused otherwise.",
    )

    index: Optional[int] = Field(
        default=None, description="The zero-based index of the rule that should be replaced or moved.",
    )
    ...
    def _exactly_one(self) -> UpdateConditionalFormatRuleRequest:
        ...
        if len(provided) != 1:
            raise ValueError(
                f"Exactly one of 'rule', 'new_index' must be set, found: {provided}"
            )
        return self
...
class UpdateDataSourceRequest(BaseModel):
    ...
    """
    data_source: Optional[DataSource] = Field(
        default=None, description="The data source to update.",
    )

    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields that should be updated. At least one field must be specified. The root `dataSource` is implied and should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None
...
class UpdateDeveloperMetadataRequest(BaseModel):
    ...
    """
    developer_metadata: Optional[DeveloperMetadata] = Field(
        default=None, description="The value that all metadata matched by the data filters will be updated to.",
    )

    data_filters: Optional[List[DataFilter]] = Field(
        default=None, description="The filters matching the developer metadata entries to update.",
    )

    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields that should be updated. At least one field must be specified. The root `developerMetadata` is implied and should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None
...
class UpdateDimensionGroupRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields that should be updated. At least one field must be specified. The root `dimensionGroup` is implied and should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None

    dimension_group: Optional[DimensionGroup] = Field(
        default=None, description="The group whose state should be updated. The range and depth of the group should specify a valid group on the sheet, and all other fields updated.",
    )
...
class UpdateDimensionPropertiesRequest(BaseModel):
    ...
    data_source_sheet_range: Optional[DataSourceSheetDimensionRange] = Field(
        default=None, description="The columns on a data source sheet to update.",
    )

    properties: Optional[DimensionProperties] = Field(
        default=None, description="Properties to update.",
    )

    range: Optional[DimensionRange] = Field(
        default=None, description="The rows or columns to update.",
    )

    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields that should be updated. At least one field must be specified. The root `properties` is implied and should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None
...
class UpdateEmbeddedObjectBorderRequest(BaseModel):
    ...
    border: Optional[EmbeddedObjectBorder] = Field(
        default=None, description="The border that applies to the embedded object.",
    )

    object_id: Optional[int] = Field(
        default=None, description="The ID of the embedded object to update.",
    )

    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields that should be updated. At least one field must be specified. The root `border` is implied and should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None
...
class UpdateEmbeddedObjectPositionRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields of OverlayPosition that should be updated when setting a new position. Used only if newPosition.overlayPosition is set, in which case at least one field must be specified. The root `newPosition.overlayPosition` is implied and should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None

    object_id: Optional[int] = Field(
        default=None, description="The ID of the object to moved.",
    )

    new_position: Optional[EmbeddedObjectPosition] = Field(
        default=None, description="An explicit position to move the embedded object to. If newPosition.sheetId is set, a new sheet with that ID will be created. If newPosition.newSheet is set to true, a new sheet will be created with an ID that will be chosen for you.",
    )
...
class UpdateFilterViewRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields that should be updated. At least one field must be specified. The root `filter` is implied and should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None

    filter: Optional[FilterView] = Field(
        default=None, description="The new properties of the filter view.",
    )
...
class UpdateNamedRangeRequest(BaseModel):
    ...
    """
    named_range: Optional[NamedRange] = Field(
        default=None, description="The named range to update with the new properties.",
    )

    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields that should be updated. At least one field must be specified. The root `namedRange` is implied and should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None
...
class UpdateProtectedRangeRequest(BaseModel):
    ...
    """
    protected_range: Optional[ProtectedRange] = Field(
        default=None, description="The protected range to update with the new properties.",
    )

    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields that should be updated. At least one field must be specified. The root `protectedRange` is implied and should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None
...
class UpdateSheetPropertiesRequest(BaseModel):
    ...
    """
    properties: Optional[SheetProperties] = Field(
        default=None, description="The properties to update.",
    )
...
class UpdateSlicerSpecRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="The fields that should be updated. At least one field must be specified. The root `SlicerSpec` is implied and should not be specified. A single \"*\"` can be used as short-hand for listing every field."),
    ] = None

    slicer_id: Optional[int] = Field(
        default=None, description="The id of the slicer to update.",
    )

    spec: Optional[SlicerSpec] = Field(
        default=None, description="The specification to apply to the slicer.",
    )
...
class UpdateTableRequest(BaseModel):
    ...
    fields: Annotated[
        Optional[FieldMask],
        Format("field_mask"), Field(default=None, description="Required. The fields that should be updated. At least one field must be specified. The root `table` is implied and should not be specified. A single `\"*\"` can be used as short-hand for listing every field."),
    ] = None

    table: Optional[Table] = Field(
        default=None, description="Required. The table to update.",
    )
...
class Request(BaseModel):
    ...
    def _exactly_one(self) -> Request:
        provided = [n for n in ('update_spreadsheet_properties', 'update_sheet_properties', 'update_dimension_properties', 'update_named_range', 'repeat_cell', 'add_named_range', 'delete_named_range', 'add_sheet', 'delete_sheet', 'auto_fill', 'cut_paste', 'copy_paste', 'merge_cells', 'unmerge_cells', 'update_borders', 'update_cells', 'add_filter_view', 'append_cells', 'clear_basic_filter', 'delete_dimension', 'delete_embedded_object', 'delete_filter_view', 'duplicate_filter_view', 'duplicate_sheet', 'find_replace', 'insert_dimension', 'insert_range', 'move_dimension', 'update_embedded_object_position', 'paste_data', 'text_to_columns', 'update_filter_view', 'delete_range', 'append_dimension', 'add_conditional_format_rule', 'update_conditional_format_rule', 'delete_conditional_format_rule', 'sort_range', 'set_data_validation', 'set_basic_filter', 'add_protected_range', 'update_protected_range', 'delete_protected_range', 'auto_resize_dimensions', 'add_chart', 'update_chart_spec', 'update_banding', 'add_banding', 'delete_banding', 'create_developer_metadata', 'update_developer_metadata', 'delete_developer_metadata', 'randomize_range', 'add_dimension_group', 'delete_dimension_group', 'update_dimension_group', 'trim_whitespace', 'delete_duplicates', 'update_embedded_object_border', 'add_slicer', 'update_slicer_spec', 'add_data_source', 'update_data_source', 'delete_data_source', 'refresh_data_source', 'cancel_data_source_refresh', 'add_table', 'update_table', 'delete_table', 'insert_comment', 'add_comment_reply', 'update_comment_post', 'delete_comment', 'delete_comment_reply') if getattr(self, n) is not None]
        if len(provided) != 1:
            raise ValueError(
                f"Exactly one request kind must be set, found: {provided}"
            )
        return self
