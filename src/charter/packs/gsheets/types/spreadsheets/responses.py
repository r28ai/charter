...
class AddBandingResponse(BaseModel):
    ...
    banded_range: Optional[BandedRange] = Field(
        default=None, description="The banded range that was added.",
    )
...
class AddChartResponse(BaseModel):
    ...
    chart: Optional[EmbeddedChart] = Field(
        default=None, description="The newly added chart.",
    )
...
class AddDataSourceResponse(BaseModel):
    ...
    data_source: Optional[DataSource] = Field(
        default=None, description="The data source that was created.",
    )
...
class AddDimensionGroupResponse(BaseModel):
    ...
    dimension_groups: Optional[List[DimensionGroup]] = Field(
        default=None, description="All groups of a dimension after adding a group to that dimension.",
    )
...
class AddFilterViewResponse(BaseModel):
    ...
    filter: Optional[FilterView] = Field(
        default=None, description="The newly added filter view.",
    )
...
class AddNamedRangeResponse(BaseModel):
    ...
    named_range: Optional[NamedRange] = Field(
        default=None, description="The named range to add.",
    )
...
class AddProtectedRangeResponse(BaseModel):
    ...
    protected_range: Optional[ProtectedRange] = Field(
        default=None, description="The newly added protected range.",
    )
...
class AddSheetResponse(BaseModel):
    ...
    properties: Optional[SheetProperties] = Field(
        default=None, description="The properties of the newly added sheet.",
    )
...
class AddSlicerResponse(BaseModel):
    ...
    slicer: Optional[Slicer] = Field(
        default=None, description="The newly added slicer.",
    )
...
class AddTableResponse(BaseModel):
    ...
    table: Annotated[
        Optional[Table],
        Mode("response_only"), Field(default=None, description="Output only. The table that was added."),
    ] = None
...
class CancelDataSourceRefreshResponse(BaseModel):
    ...
    statuses: Optional[List[CancelDataSourceRefreshStatus]] = Field(
        default=None, description="The cancellation statuses of refreshes of all data source objects specified in the request. If is_all is specified, the field contains only those in failure status. Refreshing and canceling refresh the same data source object is also not allowed in the same `batchUpdate`.",
    )
...
class CancelDataSourceRefreshStatus(BaseModel):
    ...
    reference: Optional[DataSourceObjectReference] = Field(
        default=None, description="Reference to the data source object whose refresh is being cancelled.",
    )

    refresh_cancellation_status: Optional[RefreshCancellationStatus] = Field(
        default=None, description="The cancellation status.",
    )
...
class CreateDeveloperMetadataResponse(BaseModel):
    ...
    developer_metadata: Optional[DeveloperMetadata] = Field(
        default=None, description="The developer metadata that was created.",
    )
...
class DeleteConditionalFormatRuleResponse(BaseModel):
    ...
    rule: Optional[ConditionalFormatRule] = Field(
        default=None, description="The rule that was deleted.",
    )
...
class DeleteDeveloperMetadataResponse(BaseModel):
    ...
    deleted_developer_metadata: Optional[List[DeveloperMetadata]] = Field(
        default=None, description="The metadata that was deleted.",
    )
...
class DeleteDimensionGroupResponse(BaseModel):
    ...
    """
    dimension_groups: Optional[List[DimensionGroup]] = Field(
        default=None, description="All groups of a dimension after deleting a group from that dimension.",
    )
...
class DeleteDuplicatesResponse(BaseModel):
    ...
    duplicates_removed_count: Optional[int] = Field(
        default=None, description="The number of duplicate rows removed.",
    )
...
class DuplicateFilterViewResponse(BaseModel):
    ...
    """
    filter: Optional[FilterView] = Field(
        default=None, description="The newly created filter.",
    )
...
class DuplicateSheetResponse(BaseModel):
    ...
    """
    properties: Optional[SheetProperties] = Field(
        default=None, description="The properties of the duplicate sheet.",
    )
...
class FindReplaceResponse(BaseModel):
    ...
    values_changed: Optional[int] = Field(
        default=None, description="The number of non-formula cells changed.",
    )

    rows_changed: Optional[int] = Field(
        default=None, description="The number of rows changed.",
    )

    occurrences_changed: Optional[int] = Field(
        default=None, description="The number of occurrences (possibly multiple within a cell) changed. For example, if replacing `\"e\"` with `\"o\"` in `\"Google Sheets\"`, this would be `\"3\"` because `\"Google Sheets\"` -> `\"Googlo Shoots\"`.",
    )

    formulas_changed: Optional[int] = Field(
        default=None, description="The number of formula cells changed.",
    )

    sheets_changed: Optional[int] = Field(
        default=None, description="The number of sheets changed.",
    )
...
class RefreshCancellationStatus(BaseModel):
    ...
    state: Optional[RefreshCancellationStatusState] = Field(
        default=None, description="The state of a call to cancel a refresh in Sheets.",
    )
...
class RefreshDataSourceObjectExecutionStatus(BaseModel):
    ...
    """
    reference: Optional[DataSourceObjectReference] = Field(
        default=None, description="Reference to a data source object being refreshed.",
    )
...
class RefreshDataSourceResponse(BaseModel):
    ...
    statuses: Optional[List[RefreshDataSourceObjectExecutionStatus]] = Field(
        default=None, description="All the refresh status for the data source object references specified in the request. If is_all is specified, the field contains only those in failure status.",
    )
...
class TrimWhitespaceResponse(BaseModel):
    ...
    cells_changed_count: Optional[int] = Field(
        default=None, description="The number of cells that were trimmed of whitespace.",
    )
...
class UpdateConditionalFormatRuleResponse(BaseModel):
    ...
    new_index: Optional[int] = Field(
        default=None, description="The index of the new rule.",
    )

    old_index: Optional[int] = Field(
        default=None, description="The old index of the rule. Not set if a rule was replaced (because it is the same as new_index).",
    )

    new_rule: Optional[ConditionalFormatRule] = Field(
        default=None, description="The new rule that replaced the old rule (if replacing), or the rule that was moved (if moved)",
    )

    old_rule: Optional[ConditionalFormatRule] = Field(
        default=None, description="The old (deleted) rule. Not set if a rule was moved (because it is the same as new_rule).",
    )
...
class UpdateDataSourceResponse(BaseModel):
    ...
    """
    data_source: Optional[DataSource] = Field(
        default=None, description="The updated data source.",
    )
...
class UpdateDeveloperMetadataResponse(BaseModel):
    ...
    developer_metadata: Optional[List[DeveloperMetadata]] = Field(
        default=None, description="The updated developer metadata.",
    )
...
class UpdateEmbeddedObjectPositionResponse(BaseModel):
    ...
    position: Optional[EmbeddedObjectPosition] = Field(
        default=None, description="The new position of the embedded object.",
    )
...
class BatchUpdateSpreadsheetResponse(BaseModel):
    ...
    replies: Optional[List[Response]] = Field(
        default=None, description="The reply of the updates. This maps 1:1 with the updates, although replies to some requests may be empty.",
    )

    updated_spreadsheet: Optional[Spreadsheet] = Field(
        default=None, description="The spreadsheet after updates were applied. This is only set if BatchUpdateSpreadsheetRequest.include_spreadsheet_in_response is `true`.",
    )
