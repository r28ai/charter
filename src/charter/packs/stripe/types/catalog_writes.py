...
class PricesUpdateRequest(BaseModel):
    ...
    active: Annotated[
        ...
        Field(
            None,
            description=(
                "Whether the price can be used. Setting this false is how a price is "
                "retired."
            ),
        ),
        Body(),
    ...
    nickname: Annotated[
        Optional[str], Field(None, description="An internal label."), Body()
    ]
    ...
    tax_behavior: Annotated[
        ...
        Field(
            None,
            description=(
                "Whether the amount includes tax. Settable only while it is still "
                "'unspecified'."
            ),
        ),
        Body(),
