...
class PaymentIntentsCreateRequest(BaseModel):
    ...
    payment_method: Annotated[
        ...
        Field(
            None,
            description=(
                "The payment method to charge. If it belongs to a customer, name that "
                "customer too."
            ),
        ),
        Body(),
    ...
    off_session: Annotated[
        ...
        Field(
            None,
            description=(
                "The customer is not present. Only meaningful alongside `confirm`."
            ),
        ),
        Body(),
    ]
    ...
    receipt_email: Annotated[
        ...
        Field(
            None,
            description=(
                "Email a receipt here. In live mode this sends regardless of your "
                "email settings."
            ),
        ),
        Body(),
