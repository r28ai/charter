...
class _InvoiceWriteCommon(BaseModel):
    ...
    default_payment_method: Annotated[
        ...
        Field(
            None,
            description=("The payment method to charge. It must belong to the invoice's customer."),
        ),
        Body(),
    ]
    footer: Annotated[
    ...
    statement_descriptor: Annotated[
        ...
        Field(
            None,
            description=(
                "What the customer sees on their card statement. Must contain at least one letter."
            ),
        ),
        Body(),
    ]
...
class InvoicesCreateRequest(_InvoiceWriteCommon):
    ...
    currency: Annotated[
        ...
        Field(
            None,
            description=(
                "Three-letter lowercase ISO currency code. Absent, the customer's currency."
            ),
        ),
        Body(),
    ]
