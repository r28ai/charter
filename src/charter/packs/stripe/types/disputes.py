...
class DisputeEvidence(BaseModel):
    ...
    duplicate_charge_id: Optional[str] = Field(
        None,
        description=(
            "The ID of the earlier charge that appears to be a duplicate of the disputed one."
        ),
    )
    duplicate_charge_explanation: Optional[str] = Field(
        ...
        max_length=_TEXT_LIMIT,
        description=(
            "How the disputed charge differs from the earlier one that looks like a duplicate."
        ),
    )
    ...
    shipping_carrier: Optional[str] = Field(
        None,
        description=(
            "The delivery service that shipped the product. Separate several with commas."
        ),
    )
