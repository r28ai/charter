...
invoices_list = _stripe(
    name="invoices_list",
    args_schema=InvoicesListRequest,
    method="GET",
...
invoices_create = _stripe(
    ...
    action_label="Creates a draft Stripe invoice.",
    response_handler=trim_invoices,
)

invoices_update = _stripe(
    name="invoices_update",
    args_schema=InvoicesUpdateRequest,
    method="POST",
    url_template="v1/invoices/{invoice}",
    description=(
    ...
    action_label="Updates a Stripe invoice.",
    response_handler=trim_invoices,
)

invoices_finalize = _stripe(
    name="invoices_finalize",
    args_schema=InvoicesFinalizeRequest,
    method="POST",
    ...
    action_label="Finalises a Stripe invoice.",
    response_handler=trim_invoices,
)

invoices_send = _stripe(
    name="invoices_send",
    args_schema=InvoicesSendRequest,
    method="POST",
    ...
    action_label="Emails a Stripe invoice to the customer.",
    response_handler=trim_invoices,
)

invoices_void = _stripe(
    name="invoices_void",
    args_schema=InvoicesVoidRequest,
    method="POST",
...
invoices_mark_uncollectible = _stripe(
    name="invoices_mark_uncollectible",
    args_schema=InvoicesMarkUncollectibleRequest,
    method="POST",
    url_template="v1/invoices/{invoice}/mark_uncollectible",
    description=(
        "Record an invoice as bad debt. It refunds nothing and cancels nothing; it "
        "marks the invoice for accounting."
    ),
    action_label="Marks a Stripe invoice uncollectible.",
    response_handler=trim_invoices,
)
...
payment_methods_list = _stripe(
    ...
    args_schema=PaymentMethodsListRequest,
    method="GET",
...
payment_methods_retrieve = _stripe(
    name="payment_methods_retrieve",
    args_schema=PaymentMethodsRetrieveRequest,
    method="GET",
    url_template="v1/payment_methods/{payment_method}",
    description="Retrieve a payment method by ID.",
    action_label="Looks up a Stripe payment method.",
    response_handler=trim_payment_methods,
)

payment_methods_attach = _stripe(
    name="payment_methods_attach",
    args_schema=PaymentMethodsAttachRequest,
    method="POST",
...
payment_methods_detach = _stripe(
    name="payment_methods_detach",
    args_schema=PaymentMethodsDetachRequest,
    method="POST",
    url_template="v1/payment_methods/{payment_method}/detach",
    description=(
...
customer_payment_methods_list = _stripe(
    name="customer_payment_methods_list",
    args_schema=CustomerPaymentMethodsListRequest,
    method="GET",
    url_template="v1/customers/{customer}/payment_methods",
...
customer_payment_method_retrieve = _stripe(
    ...
    args_schema=CustomerPaymentMethodRetrieveRequest,
    method="GET",
...
disputes_list = _stripe(
    name="disputes_list",
    args_schema=DisputesListRequest,
    method="GET",
...
disputes_retrieve = _stripe(
    name="disputes_retrieve",
    args_schema=DisputesRetrieveRequest,
    method="GET",
    ...
    action_label="Looks up a Stripe dispute.",
    response_handler=trim_disputes,
)

disputes_update = _stripe(
    name="disputes_update",
    args_schema=DisputesUpdateRequest,
    method="POST",
    url_template="v1/disputes/{dispute}",
    description=(
    ...
    action_label="Submits dispute evidence to the bank.",
    response_handler=trim_disputes,
)

disputes_close = _stripe(
    name="disputes_close",
    args_schema=DisputesCloseRequest,
    method="POST",
...
accounts_list = _stripe(
    name="accounts_list",
    args_schema=AccountsListRequest,
    method="GET",
...
transfers_list = _stripe(
    ...
    response_handler=trim_transfers,
    pagination_override=STRIPE_PAGINATION,
)

transfers_retrieve = _stripe(
    name="transfers_retrieve",
    args_schema=TransfersRetrieveRequest,
    method="GET",
    url_template="v1/transfers/{transfer}",
    description="Retrieve a transfer by ID.",
    action_label="Looks up a Stripe transfer.",
    response_handler=trim_transfers,
)

payouts_list = _stripe(
    name="payouts_list",
    args_schema=PayoutsListRequest,
    method="GET",
    ...
    response_handler=trim_payouts,
    pagination_override=STRIPE_PAGINATION,
)

payouts_retrieve = _stripe(
    name="payouts_retrieve",
    args_schema=PayoutsRetrieveRequest,
    method="GET",
    url_template="v1/payouts/{payout}",
    description="Retrieve a payout by ID.",
    action_label="Looks up a Stripe payout.",
    response_handler=trim_payouts,
)

application_fees_list = _stripe(
    name="application_fees_list",
    args_schema=ApplicationFeesListRequest,
    method="GET",
    ...
    response_handler=trim_application_fees,
    pagination_override=STRIPE_PAGINATION,
)

balance_transactions_list = _stripe(
    name="balance_transactions_list",
    args_schema=BalanceTransactionsListRequest,
    method="GET",
    url_template="v1/balance_transactions",
    description=(
    ...
    response_handler=trim_balance_transactions,
    pagination_override=STRIPE_PAGINATION,
)
...
invoice_items_create = _stripe(
    name="invoice_items_create",
    args_schema=InvoiceItemsCreateRequest,
    method="POST",
    ...
    action_label="Adds a line to a Stripe invoice.",
    response_handler=trim_invoice_items,
)

invoice_items_list = _stripe(
    name="invoice_items_list",
    args_schema=InvoiceItemsListRequest,
    method="GET",
    url_template="v1/invoiceitems",
...
invoice_items_update = _stripe(
    name="invoice_items_update",
    args_schema=InvoiceItemsUpdateRequest,
    method="POST",
    ...
    action_label="Updates a Stripe invoice line.",
    response_handler=trim_invoice_items,
)

invoice_items_delete = _stripe(
    name="invoice_items_delete",
    args_schema=InvoiceItemsDeleteRequest,
    method="DELETE",
    url_template="v1/invoiceitems/{invoiceitem}",
...
checkout_sessions_retrieve = _stripe(
    name="checkout_sessions_retrieve",
    args_schema=CheckoutSessionsRetrieveRequest,
    method="GET",
    url_template="v1/checkout/sessions/{session}",
    description=(
...
checkout_sessions_list = _stripe(
    name="checkout_sessions_list",
    args_schema=CheckoutSessionsListRequest,
    method="GET",
    url_template="v1/checkout/sessions",
    description=(
...
checkout_sessions_line_items = _stripe(
    ...
    args_schema=CheckoutSessionsLineItemsRequest,
    method="GET",
    ...
    response_handler=trim_line_items,
    pagination_override=STRIPE_PAGINATION,
)
...
prices_create = _stripe(
    ...
    action_label="Creates a Stripe price.",
    response_handler=trim_prices,
)

prices_update = _stripe(
    name="prices_update",
    args_schema=PricesUpdateRequest,
    method="POST",
    ...
    action_label="Updates a Stripe price.",
    response_handler=trim_prices,
)
...
payment_intents_create = _stripe(
    ...
    args_schema=PaymentIntentsCreateRequest,
    method="POST",
    url_template="v1/payment_intents",
    description=(
    ...
    action_label="Creates a Stripe payment.",
    response_handler=trim_payment_intents,
)

payment_intents_capture = _stripe(
    name="payment_intents_capture",
    args_schema=PaymentIntentsCaptureRequest,
    method="POST",
    url_template="v1/payment_intents/{intent}/capture",
    description=(
...
payment_intents_cancel = _stripe(
    name="payment_intents_cancel",
    args_schema=PaymentIntentsCancelRequest,
    method="POST",
    url_template="v1/payment_intents/{intent}/cancel",
    description="Cancel a payment, releasing any authorised funds back to the customer.",
    action_label="Cancels a Stripe payment.",
    response_handler=trim_payment_intents,
)

charges_retrieve = _stripe(
    name="charges_retrieve",
    args_schema=ChargesRetrieveRequest,
    method="GET",
    url_template="v1/charges/{charge}",
    description="Retrieve a single charge by ID.",
    action_label="Looks up a Stripe charge.",
    response_handler=trim_charges,
)
