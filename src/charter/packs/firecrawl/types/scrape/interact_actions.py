...
class ScrapeInteractRequest(BaseModel):
    ...
    code: Annotated[
        str,
        Field(..., min_length=1, max_length=100000, description="Code to execute in the scrape-bound browser sandbox"),
        Body(),
    ]
    language: Annotated[
    ...
    timeout: Annotated[
        Optional[int],
        Field(None, ge=1, le=300, description="Execution timeout in seconds. The server applies 30 when this is absent."),
        Body(),
    ]
    origin: Annotated[
        Optional[str],
