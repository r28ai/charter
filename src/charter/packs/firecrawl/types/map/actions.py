...
class MapRequest(BaseModel):
    ...
    include_subdomains: Annotated[
        ...
        Field(
            None,
            description="Include subdomains of the website. The server applies true when this is absent.",
        ),
        Body(),
    ]
    ignore_query_parameters: Annotated[
        ...
        Field(
            None,
            description="Do not return URLs with query parameters. The server applies true when this is absent.",
        ),
        Body(),
    ]
    ...
    limit: Annotated[
        ...
        Field(
            None,
            le=100000,
            description="Maximum number of links to return. The server applies 5000 when this is absent.",
        ),
        Body(),
    ]
    timeout: Annotated[
