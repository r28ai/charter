...
class SearchRequest(BaseModel):
    ...
    limit: Annotated[
        ...
        Field(
            ...
            ge=1,
            le=100,
            description="Maximum number of results to return per source type. The server applies 10 when this is absent.",
        ),
        Body(),
    ]
    sources: Annotated[
    ...
    include_domains: Annotated[
        ...
        Field(
            None,
            description="Restricts search results to these hostnames. Cannot be used with excludeDomains.",
        ),
        Body(),
        ConflictsWith(
            "exclude_domains", reason="Drop excludeDomains to restrict to includeDomains."
        ),
    ]
    exclude_domains: Annotated[
        ...
        Field(
            None,
            description="Excludes search results from these hostnames. Cannot be used with includeDomains.",
        ),
        Body(),
    ...
    location: Annotated[
        ...
        Field(
            None,
            description="Location parameter for search results (e.g. San Francisco,California,United States).",
        ),
        Body(),
    ]
    country: Annotated[
        ...
        Field(
            None,
            description="ISO country code for geo-targeting. The server applies US when this is absent.",
        ),
        Body(),
    ]
    safe: Annotated[
        ...
        Field(
            None,
            description="When true, filters explicit content from search results (SafeSearch).",
        ),
        Body(),
    ]
    timeout: Annotated[
    ...
    highlights: Annotated[
        ...
        Field(
            None,
            description="Generate query-relevant highlights. The server applies true when this is absent.",
        ),
        Body(),
    ]
    enterprise: Annotated[
        ...
        Field(
            None,
            description="Enterprise Zero Data Retention options. ['zdr'] is end-to-end ZDR; ['anon'] is anonymized ZDR.",
        ),
        Body(),
    ]
...
class ValuableSource(BaseModel):
    ...
    reason: Optional[str] = Field(
        None, max_length=1000, description="Why this source was valuable."
    )
...
class MissingContent(BaseModel):
    ...
    topic: str = Field(
        ..., min_length=1, max_length=200, description="Topic that was missing from the results."
    )
    description: Optional[str] = Field(
        None, max_length=2000, description="Additional detail about what was missing."
    )
...
class SearchFeedbackRequest(BaseModel):
    ...
    origin: Annotated[
        ...
        Field(
            None,
            description="Origin label for the feedback. The server applies 'api' when this is absent.",
        ),
        Body(),
    ]
