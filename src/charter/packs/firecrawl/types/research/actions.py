...
class ResearchPapersSearchRequest(BaseModel):
    ...
    query: Annotated[
        str, Field(..., min_length=1, description="Natural-language paper search query."), Query()
    ]
    k: Annotated[
        Optional[int],
        Field(
            ...
            ge=1,
            le=500,
            description="Maximum number of ranked papers to return. The server applies 40 when this is absent.",
        ),
        Query(),
    ]
    authors: Annotated[
...
class ResearchPaperGetRequest(BaseModel):
    ...
    query: Annotated[
        ...
        Field(
            None,
            min_length=1,
            description="When present, returns top matching full-text passages for this question.",
        ),
        Query(),
    ]
    k: Annotated[
        ...
        Field(
            ...
            ge=1,
            le=50,
            description="Passage count for read mode. Only valid when query is present. The server applies 4 when this is absent.",
        ),
        Query(),
    ]
...
class ResearchSimilarPapersRequest(BaseModel):
    ...
    mode: Annotated[
        ...
        Field(
            None,
            description="Structural expansion mode. The server applies 'similar' when this is absent.",
        ),
        Query(),
    ]
    k: Annotated[
        ...
        Field(
            ...
            ge=1,
            le=500,
            description="Maximum number of related papers to return. The server applies 40 when this is absent.",
        ),
        Query(),
    ]
    rerank: Annotated[
