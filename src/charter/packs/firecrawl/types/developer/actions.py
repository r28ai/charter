...
class DeveloperSearchRequest(BaseModel):
    ...
    query: Annotated[
        str,
        Field(..., min_length=1, description="Natural-language question or search phrase."),
        Query(),
    ]
    k: Annotated[
        Optional[int],
        Field(
            ...
            ge=1,
            le=100,
            description="Number of ranked results to return. The server applies 10 when this is absent.",
        ),
        Query(),
    ]
    types: Annotated[
    ...
    passages: Annotated[
        ...
        Field(
            ...
            ge=1,
            le=5,
            description="Matched passages to return per result. The server applies 1 when this is absent.",
        ),
        Query(),
    ]
    language: Annotated[
