...
class CrawlRequest(BaseModel):
    ...
    sitemap: Annotated[
        ...
        Field(
            None,
            description="Sitemap mode when crawling. The server applies 'include' when this is absent.",
        ),
        Body(),
    ]
    ...
    regex_on_full_url: Annotated[
        ...
        Field(
            None,
            description="Match includePaths and excludePaths against the full URL instead of just the pathname.",
        ),
        Body(),
    ...
    limit: Annotated[
        ...
        Field(
            None,
            description="Maximum number of pages to crawl. The server applies 10000 when this is absent.",
        ),
        Body(),
    ]
    crawl_entire_domain: Annotated[
        ...
        Field(
            None,
            description="Allow the crawler to follow internal links to sibling or parent URLs, not just child paths.",
        ),
        Body(),
    ]
    allow_external_links: Annotated[
        ...
        Field(
            None,
            description="Allow the crawler to follow links to external websites (one hop only).",
        ),
        Body(),
    ]
    allow_subdomains: Annotated[
        Optional[bool],
        Field(
            None, description="Allow the crawler to follow links to subdomains of the main domain."
        ),
        Body(),
    ]
    ...
    robots_user_agent: Annotated[
        Optional[str],
        Field(
            None, description="Custom User-Agent string for robots.txt evaluation. Enterprise only."
        ),
        Body(),
    ]
    delay: Annotated[
        ...
        Field(
            None,
            description="Delay in seconds between scrapes. Setting this forces concurrency to 1.",
        ),
        Body(),
    ]
