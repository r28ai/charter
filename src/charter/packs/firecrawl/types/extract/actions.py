...
class ExtractRequest(BaseModel):
    ...
    include_subdomains: Annotated[
        ...
        Field(
            None,
            description="When true, subdomains of the provided URLs will also be scanned. The server applies true when this is absent.",
        ),
        Body(),
    ]
    show_sources: Annotated[
        ...
        Field(
            None,
            description="When true, the sources used to extract the data will be included in the response as `sources`.",
        ),
        Body(),
    ]
