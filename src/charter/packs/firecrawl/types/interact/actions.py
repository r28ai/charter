...
class InteractCreateRequest(BaseModel):
    ...
    ttl: Annotated[
        ...
        Field(
            ...
            ge=30,
            le=3600,
            description="Total time-to-live in seconds for the interact session. The server applies 300 when this is absent.",
        ),
        Body(),
    ]
    ...
    stream_web_view: Annotated[
        ...
        Field(
            None,
            description="Whether to stream a live view of the browser. The server applies true when this is absent.",
        ),
        Body(),
    ]
    profile: Annotated[
