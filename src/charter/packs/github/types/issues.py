...
class IssuesListForRepoRequest(RepoRequest, GitHubListRequest):
    ...
    state: Annotated[
        ...
        Field(
            "open",
            description=("Indicates the state of the issues to return. Defaults to `open`."),
        ),
        Query(),
    ]
    assignee: Annotated[
...
class IssuesListMilestonesRequest(RepoRequest, GitHubListRequest):
    ...
    state: Annotated[
        ...
        Field(
            None,
            description=("The state of the milestone. GitHub uses `open` when this is absent."),
        ),
        Query(),
    ]
    sort: Annotated[
    ...
    direction: Annotated[
        Optional[SortDirection],
        Field(
            None, description="The direction of the sort. GitHub uses `asc` when this is absent."
        ),
        Query(),
    ]
...
class IssuesCreateMilestoneRequest(RepoRequest):
    ...
    state: Annotated[
        ...
        Field(
            None, description="The state of the milestone. GitHub uses `open` when this is absent."
        ),
        Body(),
    ]
    description: Annotated[
...
class _IssueCommentId(RepoRequest):
    comment_id: Annotated[
        ...
        Field(
            ...,
            description=(
                "The unique identifier of the comment — its `id`, not the issue number it sits on."
            ),
        ),
        Path(),
    ]
...
class IssuesListForAuthenticatedUserRequest(GitHubListRequest):
    ...
    sort: Annotated[
        Optional[IssueSort],
        Field(
            None, description="What to sort results by. GitHub uses `created` when this is absent."
        ),
        Query(),
    ]
    direction: Annotated[
