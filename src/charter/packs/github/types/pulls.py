...
class ReviewComment(BaseModel):
    ...
    start_line: Optional[int] = Field(None, description="The first line of a multi-line comment.")
    ...
    def _placement_is_complete_and_unambiguous(self) -> PullsCreateReviewCommentRequest:
        ...
        if self.start_line is not None:
            if self.start_side is None:
                raise ValueError("A multi-line comment needs `start_side` beside `start_line`.")
