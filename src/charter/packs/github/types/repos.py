...
class ReposGetContentRequest(RepoRequest):
    ...
    ref: Annotated[
        ...
        Field(
            None,
            description=(
                "The name of the commit/branch/tag. Defaults to the repository's "
                "default branch."
            ),
        ),
        Query(),
...
class ReposCompareCommitsRequest(RepoRequest, GitHubListRequest):
    ...
    def _basehead_has_both_sides(self) -> ReposCompareCommitsRequest:
        ...
        if not base or not head:
            raise ValueError(
                f"`basehead` needs a ref on both sides of the '...', got "
                f"'{self.basehead}'."
            )
        return self
...
class ReposGetReadmeRequest(RepoRequest):
    ...
    ref: Annotated[
        ...
        Field(
            None,
            description=(
                "The name of the commit/branch/tag. Absent, the repository's default "
                "branch."
            ),
        ),
        Query(),
...
class ReposCreateForkRequest(RepoRequest):
    ...
    name: Annotated[
        Optional[str],
        Field(None, description="When forking from an existing repository, a new name for the fork."),
        Body(),
    ]
