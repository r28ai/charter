...
class ActionsCreateWorkflowDispatchRequest(_WorkflowId):
    ...
    ref: Annotated[
        ...
        Field(
            ...,
            description=(
                "The git reference for the workflow. The reference can be a branch or "
                "tag name."
            ),
        ),
        Body(),
...
class ActionsListRunsForWorkflowRequest(_WorkflowId, GitHubListRequest):
    ...
    check_suite_id: Annotated[
        Optional[int],
        Field(None, description="Returns workflow runs with the `check_suite_id` that you specify."),
        Query(),
    ]
    head_sha: Annotated[
        Optional[str],
...
class ActionsReviewPendingDeploymentsRequest(_RunId):
    ...
    state: Annotated[
        DeploymentReviewState,
        Field(..., description="Whether to approve or reject deployment to the specified environments."),
        Body(),
    ]
    comment: Annotated[
        str,
