...
class MessageMetadata(BaseModel):
    ...
    event_type: str = Field(
        ..., description="The name of the metadata event, e.g. 'task_created'."
    )
...
class ChatUpdateRequest(BaseModel):
    ...
    reply_broadcast: Annotated[
        ...
        Field(
            None,
            description=(
                "Broadcast an existing thread reply to the channel. Defaults to false."
            ),
        ),
        Body(),
    ]
...
class ChatScheduleMessageRequest(BaseModel):
    ...
    post_at: Annotated[
        ...
        Field(
            ...,
            description=(
                "Unix timestamp representing the future time the message should "
                "post to Slack."
            ),
        ),
        Body(),
    ...
    text: Annotated[
        str, Field(..., description="The message text, as Slack markup."), Body()
    ]
    thread_ts: Annotated[
        Optional[str],
        Field(None, description="Post into this thread rather than the channel."),
