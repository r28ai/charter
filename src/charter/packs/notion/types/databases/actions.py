...
class DatabaseParent(BaseModel):
    ...
    type: Optional[Literal["page_id", "workspace"]] = Field(None, description="The type of parent.")
...
class DatabasesUpdateRequest(BaseModel):
    ...
    database_id: Annotated[str, Field(..., description=DATABASE_ID), Path()]
    body: Annotated[DatabaseUpdateBody, Field(..., description="The fields to change."), Body()]
