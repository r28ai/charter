...
class PagePropertyValue(BaseModel):
    ...
    number: Optional[float] = Field(None, description="A number. Send null to clear it.")
    ...
    status: Optional[StatusValue] = Field(None, description="The current status of the page.")
    date: Optional[DateValue] = Field(
    ...
    url: Optional[str] = Field(None, max_length=2000, description="A URL. Maximum 2000 characters.")
