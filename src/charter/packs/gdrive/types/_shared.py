...
SupportsAllDrives = Annotated[
    Optional[bool], Field(None, description=SUPPORTS_ALL_DRIVES), Query()
]
...
AcknowledgeAbuse = Annotated[
    Optional[bool], Field(None, description=ACKNOWLEDGE_ABUSE), Query()
]
TransferOwnership = Annotated[
    Optional[bool], Field(None, description=TRANSFER_OWNERSHIP), Query()
]
