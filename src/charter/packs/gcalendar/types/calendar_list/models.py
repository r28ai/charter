...
class CalendarListEntry(BaseModel):
    ...
    etag: Annotated[
        Optional[str], Field(None, description="ETag of the resource."), Mode("response_only")
    ]
    id: Annotated[str, Field(..., description="Identifier of the calendar."), Mode("response_only")]
    summary: Annotated[
        Optional[str],
...
class CalendarListResponse(BaseModel):
    ...
    etag: Annotated[Optional[str], Field(None), Mode("response_only")]
    next_page_token: Annotated[Optional[str], Field(None), Mode("response_only")]
    next_sync_token: Annotated[Optional[str], Field(None), Mode("response_only")]
    items: Annotated[Optional[List[CalendarListEntry]], Field(None), Mode("response_only")]
