...
class EventDateTime(BaseModel):
    ...
    date: Annotated[
        Optional[date],
        Field(
            None, description='The date, in the format "yyyy-mm-dd", if this is an all-day event.'
        ),
    ]
...
class Attendee(BaseModel):
    ...
    response_status: Optional[Literal["needsAction", "declined", "tentative", "accepted"]] = Field(
        None,
        description=(
...
class BirthdayProperties(BaseModel):
    ...
    type: Optional[Literal["anniversary", "birthday", "custom", "other", "self"]] = Field(
        "birthday",
        description=(
...
class EntryPoint(BaseModel):
    ...
    entry_point_type: Optional[Literal["video", "phone", "sip", "more"]] = Field(
        None,
        description=(
...
class OfficeLocation(BaseModel):
    ...
    floor_section_id: Optional[str] = Field(
        None, description="An optional floor section identifier."
    )
    label: Optional[str] = Field(
        None,
