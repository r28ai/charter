...
viewer = _query(
    "viewer", types.ViewerRequest, queries.VIEWER, "viewer",
...
team_get = _query(
    "team_get", types.TeamGetRequest, queries.TEAM, "team",
...
user_get = _query(
    "user_get", types.UserGetRequest, queries.USER, "user",
    "Get one workspace member. Pass 'me' to get the authenticated user.",
    "Reads a Linear member.",
)

workflow_states_list_full = _query(
    "workflow_states_list", types.WorkflowStatesListRequest, queries.WORKFLOW_STATES,
    "workflowStates",
    ...
    "right ones.",
    "Lists Linear statuses.", paginates=True,
)

workflow_states_list = workflow_states_list_full.derived(
    name="workflow_states_list", keep=curation.list_filter_paths(workflow_states_list_full.args_schema)
)

workflow_state_get = _query(
    "workflow_state_get", types.WorkflowStateGetRequest, queries.WORKFLOW_STATE,
    "workflowState",
...
workflow_state_create = _mutation(
    "workflow_state_create", types.WorkflowStateCreateRequest,
    queries.WORKFLOW_STATE_CREATE, "workflowStateCreate",
    "Create a workflow state for a team. `name`, `team_id`, `type` and `color` "
    "are all required.",
    "Creates a Linear status.",
)

workflow_state_update = _mutation(
    "workflow_state_update", types.WorkflowStateUpdateRequest,
    queries.WORKFLOW_STATE_UPDATE, "workflowStateUpdate",
...
workflow_state_archive = _mutation(
    "workflow_state_archive", types.WorkflowStateArchiveRequest,
    queries.WORKFLOW_STATE_ARCHIVE, "workflowStateArchive",
    "Archive a workflow state, taking it out of the team's workflow.",
    "Archives a Linear status.",
)

team_memberships_list = _query(
    "team_memberships_list", types.TeamMembershipsListRequest, queries.TEAM_MEMBERSHIPS,
    "teamMemberships",
    "List who belongs to which team, and who owns each one.",
    "Lists Linear team members.", paginates=True,
)

team_membership_get = _query(
    "team_membership_get", types.TeamMembershipGetRequest, queries.TEAM_MEMBERSHIP,
    "teamMembership",
...
team_membership_create = _mutation(
    "team_membership_create", types.TeamMembershipCreateRequest,
    queries.TEAM_MEMBERSHIP_CREATE, "teamMembershipCreate",
    "Add a member to a team.",
    "Adds a member to a Linear team.",
)

team_membership_update = _mutation(
    "team_membership_update", types.TeamMembershipUpdateRequest,
    queries.TEAM_MEMBERSHIP_UPDATE, "teamMembershipUpdate",
...
team_membership_delete = _mutation(
    "team_membership_delete", types.TeamMembershipDeleteRequest,
    queries.TEAM_MEMBERSHIP_DELETE, "teamMembershipDelete",
...
issues_list_full = _query(
    "issues_list", types.IssuesListRequest, queries.ISSUES, "issues",
    ...
    "Lists Linear issues.", paginates=True,
)
...
issue_get = _query(
    "issue_get", types.IssueGetRequest, queries.ISSUE, "issue",
...
issue_create = _mutation(
    "issue_create", types.IssueCreateRequest, queries.ISSUE_CREATE, "issueCreate",
...
issue_update = _mutation(
    "issue_update", types.IssueUpdateRequest, queries.ISSUE_UPDATE, "issueUpdate",
...
issue_batch_update = _mutation(
    "issue_batch_update", types.IssueBatchUpdateRequest, queries.ISSUE_BATCH_UPDATE,
    "issueBatchUpdate",
...
issue_delete = _mutation(
    "issue_delete", types.IssueDeleteRequest, queries.ISSUE_DELETE, "issueDelete",
...
issue_archive = _mutation(
    "issue_archive", types.IssueArchiveRequest, queries.ISSUE_ARCHIVE, "issueArchive",
...
issue_unarchive = _mutation(
    "issue_unarchive", types.IssueUnarchiveRequest, queries.ISSUE_UNARCHIVE,
    "issueUnarchive",
...
issue_add_label = _mutation(
    "issue_add_label", types.IssueAddLabelRequest, queries.ISSUE_ADD_LABEL,
    "issueAddLabel",
...
issue_remove_label = _mutation(
    "issue_remove_label", types.IssueRemoveLabelRequest, queries.ISSUE_REMOVE_LABEL,
    "issueRemoveLabel",
...
issue_subscribe = _mutation(
    "issue_subscribe", types.IssueSubscribeRequest, queries.ISSUE_SUBSCRIBE,
    "issueSubscribe",
...
issue_unsubscribe = _mutation(
    "issue_unsubscribe", types.IssueUnsubscribeRequest, queries.ISSUE_UNSUBSCRIBE,
    "issueUnsubscribe",
...
issue_relations_list = _query(
    "issue_relations_list", types.IssueRelationsListRequest, queries.ISSUE_RELATIONS,
    "issueRelations",
    "List the links between issues across the workspace. To see one issue's "
    "links, read the issue with `issue_get` instead.",
    "Lists Linear issue links.", paginates=True,
)

issue_relation_get = _query(
    "issue_relation_get", types.IssueRelationGetRequest, queries.ISSUE_RELATION,
    "issueRelation",
...
issue_relation_create = _mutation(
    "issue_relation_create", types.IssueRelationCreateRequest,
    queries.ISSUE_RELATION_CREATE, "issueRelationCreate",
...
issue_relation_update = _mutation(
    "issue_relation_update", types.IssueRelationUpdateRequest,
    queries.ISSUE_RELATION_UPDATE, "issueRelationUpdate",
...
issue_relation_delete = _mutation(
    "issue_relation_delete", types.IssueRelationDeleteRequest,
    queries.ISSUE_RELATION_DELETE, "issueRelationDelete",
    "Unlink two issues.",
...
comment_get = _query(
    "comment_get", types.CommentGetRequest, queries.COMMENT, "comment",
    "Get one comment with its replies. Name it by UUID, or by the hash from a "
    "Linear comment URL.",
    "Reads a Linear comment.",
)

comment_create = _mutation(
    "comment_create", types.CommentCreateRequest, queries.COMMENT_CREATE,
    "commentCreate",
...
comment_update = _mutation(
    "comment_update", types.CommentUpdateRequest, queries.COMMENT_UPDATE,
    "commentUpdate",
...
comment_delete = _mutation(
    "comment_delete", types.CommentDeleteRequest, queries.COMMENT_DELETE,
    "commentDelete",
    "Delete a comment.",
...
comment_resolve = _mutation(
    "comment_resolve", types.CommentResolveRequest, queries.COMMENT_RESOLVE,
    "commentResolve",
...
comment_unresolve = _mutation(
    "comment_unresolve", types.CommentUnresolveRequest, queries.COMMENT_UNRESOLVE,
    "commentUnresolve",
...
reaction_create = _mutation(
    "reaction_create", types.ReactionCreateRequest, queries.REACTION_CREATE,
    "reactionCreate",
...
reaction_delete = _mutation(
    "reaction_delete", types.ReactionDeleteRequest, queries.REACTION_DELETE,
    "reactionDelete",
    "Remove a reaction.",
...
issue_labels_list_full = _query(
    "issue_labels_list", types.IssueLabelsListRequest, queries.ISSUE_LABELS,
    "issueLabels",
    "List the workspace's issue labels, with the UUIDs `issue_create` and "
    "`issue_update` need.",
    "Lists Linear labels.", paginates=True,
)
...
issue_label_get = _query(
    "issue_label_get", types.IssueLabelGetRequest, queries.ISSUE_LABEL, "issueLabel",
    "Get one label by its UUID.",
    "Reads a Linear label.",
)

issue_label_create = _mutation(
    "issue_label_create", types.IssueLabelCreateRequest, queries.ISSUE_LABEL_CREATE,
    "issueLabelCreate",
...
issue_label_update = _mutation(
    "issue_label_update", types.IssueLabelUpdateRequest, queries.ISSUE_LABEL_UPDATE,
    "issueLabelUpdate",
...
issue_label_delete = _mutation(
    "issue_label_delete", types.IssueLabelDeleteRequest, queries.ISSUE_LABEL_DELETE,
    "issueLabelDelete",
...
project_labels_list = _query(
    "project_labels_list", types.ProjectLabelsListRequest, queries.PROJECT_LABELS,
    "projectLabels",
    "List the labels that tag projects. These are a different set from issue "
    "labels and are not interchangeable.",
    "Lists Linear project labels.", paginates=True,
)

# ---------- projects ----------

projects_list_full = _query(
    "projects_list", types.ProjectsListRequest, queries.PROJECTS, "projects",
    "List projects in the workspace, with their status and progress.",
    "Lists Linear projects.", paginates=True,
)
...
project_get = _query(
    "project_get", types.ProjectGetRequest, queries.PROJECT, "project",
...
project_create = _mutation(
    "project_create", types.ProjectCreateRequest, queries.PROJECT_CREATE,
    "projectCreate",
...
project_update = _mutation(
    "project_update", types.ProjectUpdateRequest, queries.PROJECT_UPDATE,
    "projectUpdate",
...
project_delete = _mutation(
    "project_delete", types.ProjectDeleteRequest, queries.PROJECT_DELETE,
    "projectDelete",
...
project_unarchive = _mutation(
    "project_unarchive", types.ProjectUnarchiveRequest, queries.PROJECT_UNARCHIVE,
    "projectUnarchive",
...
project_add_label = _mutation(
    "project_add_label", types.ProjectAddLabelRequest, queries.PROJECT_ADD_LABEL,
    "projectAddLabel",
...
project_remove_label = _mutation(
    "project_remove_label", types.ProjectRemoveLabelRequest,
    queries.PROJECT_REMOVE_LABEL, "projectRemoveLabel",
    "Remove one project label from a project.",
    "Unlabels a Linear project.",
)

project_statuses_list = _query(
    "project_statuses_list", types.ProjectStatusesListRequest, queries.PROJECT_STATUSES,
    "projectStatuses",
    ...
    "Lists Linear project statuses.", paginates=True,
)

project_milestones_list_full = _query(
    "project_milestones_list", types.ProjectMilestonesListRequest,
    queries.PROJECT_MILESTONES, "projectMilestones",
    "List project milestones. Filter by project to get one project's.",
    "Lists Linear milestones.", paginates=True,
)

project_milestones_list = project_milestones_list_full.derived(
    name="project_milestones_list", keep=curation.list_filter_paths(project_milestones_list_full.args_schema)
)

project_milestone_get = _query(
    "project_milestone_get", types.ProjectMilestoneGetRequest,
    queries.PROJECT_MILESTONE, "projectMilestone",
    "Get one project milestone by its UUID.",
    "Reads a Linear milestone.",
)

project_milestone_create = _mutation(
    "project_milestone_create", types.ProjectMilestoneCreateRequest,
    queries.PROJECT_MILESTONE_CREATE, "projectMilestoneCreate",
    "Create a milestone inside a project.",
    "Creates a Linear milestone.",
)

project_milestone_update = _mutation(
    "project_milestone_update", types.ProjectMilestoneUpdateRequest,
    queries.PROJECT_MILESTONE_UPDATE, "projectMilestoneUpdate",
...
project_milestone_delete = _mutation(
    "project_milestone_delete", types.ProjectMilestoneDeleteRequest,
    queries.PROJECT_MILESTONE_DELETE, "projectMilestoneDelete",
    "Delete a project milestone.",
    "Deletes a Linear milestone.",
)

project_updates_list_full = _query(
    "project_updates_list", types.ProjectUpdatesListRequest, queries.PROJECT_UPDATES,
    "projectUpdates",
    ...
    "Reads Linear project updates.", paginates=True,
)

project_updates_list = project_updates_list_full.derived(
    name="project_updates_list", keep=curation.list_filter_paths(project_updates_list_full.args_schema)
)

project_update_get = _query(
    "project_update_get", types.ProjectUpdateGetRequest, queries.PROJECT_UPDATE_GET,
    "projectUpdate",
...
project_update_create = _mutation(
    "project_update_create", types.ProjectUpdateCreateRequest,
    queries.PROJECT_UPDATE_CREATE, "projectUpdateCreate",
...
project_update_update = _mutation(
    "project_update_update", types.ProjectUpdateUpdateRequest,
    queries.PROJECT_UPDATE_UPDATE, "projectUpdateUpdate",
    "Edit a project status update that has already been posted.",
    "Edits a Linear project update.",
)

project_update_archive = _mutation(
    "project_update_archive", types.ProjectUpdateArchiveRequest,
    queries.PROJECT_UPDATE_ARCHIVE, "projectUpdateArchive",
...
cycle_get = _query(
    "cycle_get", types.CycleGetRequest, queries.CYCLE, "cycle",
    "Get one cycle with the issues in it.",
    "Reads a Linear cycle.",
)

cycle_update = _mutation(
    "cycle_update", types.CycleUpdateRequest, queries.CYCLE_UPDATE, "cycleUpdate",
...
cycle_archive = _mutation(
    "cycle_archive", types.CycleArchiveRequest, queries.CYCLE_ARCHIVE, "cycleArchive",
    "Archive a cycle.",
    "Archives a Linear cycle.",
)

cycle_start_upcoming_today = _mutation(
    "cycle_start_upcoming_today", types.CycleStartUpcomingCycleTodayRequest,
    queries.CYCLE_START_UPCOMING_CYCLE_TODAY, "cycleStartUpcomingCycleToday",
...
initiatives_list_full = _query(
    "initiatives_list", types.InitiativesListRequest, queries.INITIATIVES,
    "initiatives",
    "List initiatives — the grouping above a project, and what Linear replaced "
    "roadmaps with.",
    "Lists Linear initiatives.", paginates=True,
)
...
initiative_get = _query(
    "initiative_get", types.InitiativeGetRequest, queries.INITIATIVE, "initiative",
    "Get one initiative with its projects and links.",
    "Reads a Linear initiative.",
)

initiative_create = _mutation(
    "initiative_create", types.InitiativeCreateRequest, queries.INITIATIVE_CREATE,
    "initiativeCreate",
...
initiative_update = _mutation(
    "initiative_update", types.InitiativeUpdateRequest, queries.INITIATIVE_UPDATE,
    "initiativeUpdate",
...
initiative_delete = _mutation(
    "initiative_delete", types.InitiativeDeleteRequest, queries.INITIATIVE_DELETE,
    "initiativeDelete",
...
initiative_archive = _mutation(
    "initiative_archive", types.InitiativeArchiveRequest, queries.INITIATIVE_ARCHIVE,
    "initiativeArchive",
...
initiative_unarchive = _mutation(
    "initiative_unarchive", types.InitiativeUnarchiveRequest,
    queries.INITIATIVE_UNARCHIVE, "initiativeUnarchive",
    "Restore an archived initiative.",
    "Restores a Linear initiative.",
)

initiative_to_project_create = _mutation(
    "initiative_to_project_create", types.InitiativeToProjectCreateRequest,
    queries.INITIATIVE_TO_PROJECT_CREATE, "initiativeToProjectCreate",
    "Add a project to an initiative.",
    "Adds a project to a Linear initiative.",
)

initiative_to_project_delete = _mutation(
    "initiative_to_project_delete", types.InitiativeToProjectDeleteRequest,
    queries.INITIATIVE_TO_PROJECT_DELETE, "initiativeToProjectDelete",
...
initiative_updates_list = _query(
    "initiative_updates_list", types.InitiativeUpdatesListRequest,
    queries.INITIATIVE_UPDATES, "initiativeUpdates",
    "Read the status updates posted on initiatives.",
    "Reads Linear initiative updates.", paginates=True,
)

initiative_update_create = _mutation(
    "initiative_update_create", types.InitiativeUpdateCreateRequest,
    queries.INITIATIVE_UPDATE_CREATE, "initiativeUpdateCreate",
...
documents_list_full = _query(
    "documents_list", types.DocumentsListRequest, queries.DOCUMENTS, "documents",
    "List documents. Filter by project or initiative to scope them.",
    "Lists Linear documents.", paginates=True,
)
...
document_get = _query(
    "document_get", types.DocumentGetRequest, queries.DOCUMENT, "document",
    "Get one document with its full content. Accepts the document's UUID or "
    "the slug from its URL.",
    "Reads a Linear document.",
)

document_create = _mutation(
    "document_create", types.DocumentCreateRequest, queries.DOCUMENT_CREATE,
    "documentCreate",
...
document_update = _mutation(
    "document_update", types.DocumentUpdateRequest, queries.DOCUMENT_UPDATE,
    "documentUpdate",
...
document_delete = _mutation(
    "document_delete", types.DocumentDeleteRequest, queries.DOCUMENT_DELETE,
    "documentDelete",
...
document_unarchive = _mutation(
    "document_unarchive", types.DocumentUnarchiveRequest, queries.DOCUMENT_UNARCHIVE,
    "documentUnarchive",
...
attachments_list_full = _query(
    "attachments_list", types.AttachmentsListRequest, queries.ATTACHMENTS,
    "attachments",
    "List attachments — the links between Linear issues and things outside it.",
    "Lists Linear attachments.", paginates=True,
)
...
attachment_get = _query(
    "attachment_get", types.AttachmentGetRequest, queries.ATTACHMENT, "attachment",
    "Get one attachment and the issue it is on.",
    "Reads a Linear attachment.",
)

attachments_for_url = _query(
    "attachments_for_url", types.AttachmentsForUrlRequest, queries.ATTACHMENTS_FOR_URL,
    "attachmentsForURL",
    "Find which issues an external URL is attached to. This is the tool for "
    "'is this pull request already linked to an issue?'.",
    "Looks up a Linear attachment by URL.", paginates=True,
)

attachment_create = _mutation(
    "attachment_create", types.AttachmentCreateRequest, queries.ATTACHMENT_CREATE,
    "attachmentCreate",
...
attachment_update = _mutation(
    "attachment_update", types.AttachmentUpdateRequest, queries.ATTACHMENT_UPDATE,
    "attachmentUpdate",
...
attachment_delete = _mutation(
    "attachment_delete", types.AttachmentDeleteRequest, queries.ATTACHMENT_DELETE,
    "attachmentDelete",
...
customers_list_full = _query(
    "customers_list", types.CustomersListRequest, queries.CUSTOMERS, "customers",
    "List customers — the companies whose requests Linear tracks against "
    "issues.",
    "Lists Linear customers.", paginates=True,
)
...
customer_get = _query(
    "customer_get", types.CustomerGetRequest, queries.CUSTOMER, "customer",
    "Get one customer by its UUID.",
    "Reads a Linear customer.",
)

customer_create = _mutation(
    "customer_create", types.CustomerCreateRequest, queries.CUSTOMER_CREATE,
    "customerCreate",
...
customer_update = _mutation(
    "customer_update", types.CustomerUpdateRequest, queries.CUSTOMER_UPDATE,
    "customerUpdate",
...
customer_delete = _mutation(
    "customer_delete", types.CustomerDeleteRequest, queries.CUSTOMER_DELETE,
    "customerDelete",
    "Delete a customer.",
...
customer_needs_list_full = _query(
    "customer_needs_list", types.CustomerNeedsListRequest, queries.CUSTOMER_NEEDS,
    "customerNeeds",
    ...
    "Lists Linear customer requests.", paginates=True,
)

customer_needs_list = customer_needs_list_full.derived(
    name="customer_needs_list", keep=curation.list_filter_paths(customer_needs_list_full.args_schema)
)

customer_need_create = _mutation(
    "customer_need_create", types.CustomerNeedCreateRequest,
    queries.CUSTOMER_NEED_CREATE, "customerNeedCreate",
...
customer_need_update = _mutation(
    "customer_need_update", types.CustomerNeedUpdateRequest,
    queries.CUSTOMER_NEED_UPDATE, "customerNeedUpdate",
...
customer_need_delete = _mutation(
    "customer_need_delete", types.CustomerNeedDeleteRequest,
    queries.CUSTOMER_NEED_DELETE, "customerNeedDelete",
    "Delete a customer request.",
    "Deletes a Linear customer request.",
)

customer_statuses_list = _query(
    "customer_statuses_list", types.CustomerStatusesListRequest,
    queries.CUSTOMER_STATUSES, "customerStatuses",
    "List the statuses a customer can be in, with the UUIDs customer writes "
    "need.",
    "Lists Linear customer statuses.", paginates=True,
)

customer_tiers_list = _query(
    "customer_tiers_list", types.CustomerTiersListRequest, queries.CUSTOMER_TIERS,
    "customerTiers",
    "List the tiers a customer can be assigned to.",
    "Lists Linear customer tiers.", paginates=True,
)

# ---------- notifications, favorites, saved views ----------

notifications_list = _query(
    "notifications_list", types.NotificationsListRequest, queries.NOTIFICATIONS,
    "notifications",
    "Read the authenticated user's notifications — what Linear has told them "
    "about and what is still unread.",
    "Reads Linear notifications.", paginates=True,
)

notification_get = _query(
    "notification_get", types.NotificationGetRequest, queries.NOTIFICATION,
    "notification",
...
notification_update = _mutation(
    "notification_update", types.NotificationUpdateRequest, queries.NOTIFICATION_UPDATE,
    "notificationUpdate",
    "Mark a notification read by setting `read_at`, or snooze it with "
    "`snoozed_until_at`.",
    "Updates a Linear notification.",
)

notification_archive = _mutation(
    "notification_archive", types.NotificationArchiveRequest,
    queries.NOTIFICATION_ARCHIVE, "notificationArchive",
    "Archive a notification.",
    "Archives a Linear notification.",
)

notification_unarchive = _mutation(
    "notification_unarchive", types.NotificationUnarchiveRequest,
    queries.NOTIFICATION_UNARCHIVE, "notificationUnarchive",
    "Restore an archived notification.",
    "Restores a Linear notification.",
)

notification_mark_read_all = _mutation(
    "notification_mark_read_all", types.NotificationMarkReadAllRequest,
    queries.NOTIFICATION_MARK_READ_ALL, "notificationMarkReadAll",
...
favorites_list = _query(
    "favorites_list", types.FavoritesListRequest, queries.FAVORITES, "favorites",
    "List what the authenticated user has starred.",
    "Lists Linear favorites.", paginates=True,
)

favorite_create = _mutation(
    "favorite_create", types.FavoriteCreateRequest, queries.FAVORITE_CREATE,
    "favoriteCreate",
    "Star an issue, project, document, view, label, team or user. Give exactly "
    "one target.",
    "Stars something in Linear.",
)

favorite_update = _mutation(
    "favorite_update", types.FavoriteUpdateRequest, queries.FAVORITE_UPDATE,
    "favoriteUpdate",
...
favorite_delete = _mutation(
    "favorite_delete", types.FavoriteDeleteRequest, queries.FAVORITE_DELETE,
    "favoriteDelete",
    "Unstar something.",
...
custom_views_list = _query(
    "custom_views_list", types.CustomViewsListRequest, queries.CUSTOM_VIEWS,
    "customViews",
    "List the workspace's saved views, each with the filter it holds.",
    "Lists Linear saved views.", paginates=True,
)

custom_view_get = _query(
    "custom_view_get", types.CustomViewGetRequest, queries.CUSTOM_VIEW, "customView",
...
custom_view_create_full = _mutation(
    "custom_view_create", types.CustomViewCreateRequest, queries.CUSTOM_VIEW_CREATE,
    "customViewCreate",
    "Save a filter as a view. `filter_data` takes the same shape `issues_list` "
    "accepts.",
...
custom_view_delete = _mutation(
    "custom_view_delete", types.CustomViewDeleteRequest, queries.CUSTOM_VIEW_DELETE,
    "customViewDelete",
    "Delete a saved view.",
...
search_issues_full = _query(
    "search_issues", types.SearchIssuesRequest, queries.SEARCH_ISSUES, "searchIssues",
    ...
    "Searches Linear issues.", paginates=True,
)
...
search_projects = _query(
    "search_projects", types.SearchProjectsRequest, queries.SEARCH_PROJECTS,
    "searchProjects",
    "Search projects by text, across names and descriptions.",
    "Searches Linear projects.", paginates=True,
)

search_documents = _query(
    "search_documents", types.SearchDocumentsRequest, queries.SEARCH_DOCUMENTS,
    "searchDocuments",
    "Search documents by text, across titles and content.",
    "Searches Linear documents.", paginates=True,
)

# ---------- webhooks ----------

webhooks_list = _query(
    "webhooks_list", types.WebhooksListRequest, queries.WEBHOOKS, "webhooks",
    "List the workspace's webhooks.",
    "Lists Linear webhooks.", paginates=True,
)

webhook_get = _query(
    "webhook_get", types.WebhookGetRequest, queries.WEBHOOK, "webhook",
    "Get one webhook by its UUID.",
    "Reads a Linear webhook.",
)

webhook_create = _mutation(
    "webhook_create", types.WebhookCreateRequest, queries.WEBHOOK_CREATE,
    "webhookCreate",
...
webhook_update = _mutation(
    "webhook_update", types.WebhookUpdateRequest, queries.WEBHOOK_UPDATE,
    "webhookUpdate",
...
webhook_delete = _mutation(
    "webhook_delete", types.WebhookDeleteRequest, queries.WEBHOOK_DELETE,
    "webhookDelete",
    "Delete a webhook.",
