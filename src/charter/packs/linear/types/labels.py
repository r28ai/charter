...
class IssueLabelCreateInput(BaseModel):
    ...
    description: Optional[str] = Field(None, description="The description of the label.")
    team_id: Optional[str] = Field(
        None,
        description=(
            "The team associated with the label. Omit it for a label the whole workspace can use."
        ),
    )
    parent_id: Optional[str] = Field(None, description="The identifier of the parent label group.")
