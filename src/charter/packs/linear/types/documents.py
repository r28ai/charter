...
class DocumentCreateInput(BaseModel):
    ...
    content: Optional[str] = Field(None, description="The document content as markdown.")
    project_id: Optional[str] = Field(None, description="Related project for the document.")
    initiative_id: Optional[str] = Field(None, description="Related initiative for the document.")
    issue_id: Optional[str] = Field(None, description="Related issue for the document.")
    cycle_id: Optional[str] = Field(None, description="Related cycle for the document.")
    team_id: Optional[str] = Field(None, description="Related team for the document.")
    ...
    release_id: Optional[str] = Field(None, description="Related release for the document.")
...
class DocumentUpdateInput(BaseModel):
    ...
    icon: Optional[str] = Field(None, description="The icon of the document.")
    color: Optional[str] = Field(None, description="The color of the icon, as a hex string.")
    trashed: Optional[bool] = Field(None, description="Whether the document has been trashed.")
    last_applied_template_id: Optional[str] = Field(
        None, description="The ID of the last template applied to the document."
    )
    release_id: Optional[str] = Field(None, description="Related release for the document.")
