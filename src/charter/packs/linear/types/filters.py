...
class UserFilter(BaseModel):
    ...
    display_name: Optional[StringComparator] = Field(None, description="Filter by display name.")
...
class TeamFilter(BaseModel):
    ...
    key: Optional[StringComparator] = Field(None, description="Filter by team key, e.g. 'ENG'.")
...
class WorkflowStateFilter(BaseModel):
    ...
    team: Optional[TeamFilter] = Field(None, description="Filter by the team the state belongs to.")
    created_at: Optional[DateComparator] = Field(
...
class IssueLabelFilter(BaseModel):
    ...
    team: Optional[NullableTeamFilter] = Field(
        None,
        description=(
            "Filter by the team the label belongs to. Workspace-wide labels have no team."
        ),
    )
...
class CycleFilter(BaseModel):
    ...
    name: Optional[StringComparator] = Field(None, description="Comparator for the cycle name.")
    number: Optional[NumberComparator] = Field(None, description="Filter by the cycle's number.")
    starts_at: Optional[DateComparator] = Field(
        None, description="Filter by when the cycle starts."
    )
    ends_at: Optional[DateComparator] = Field(None, description="Filter by when the cycle ends.")
    ...
    team: Optional[TeamFilter] = Field(None, description="Filter by the team the cycle belongs to.")
    created_at: Optional[DateComparator] = Field(
...
class ProjectFilter(BaseModel):
    ...
    slug_id: Optional[StringComparator] = Field(None, description="Filter by the project's slug.")
    ...
    health: Optional[StringComparator] = Field(
        None,
        description=("Filter by the project's health: 'onTrack', 'atRisk' or 'offTrack'."),
    )
    ...
    lead: Optional[UserFilter] = Field(None, description="Filter by the project's lead.")
    creator: Optional[UserFilter] = Field(None, description="Filter by who created the project.")
    members: Optional[UserCollectionFilter] = Field(
    ...
    customer_count: Optional[NumberComparator] = Field(None, description="Count of customers.")
...
class IssueFilter(BaseModel):
    ...
    title: Optional[StringComparator] = Field(None, description="Comparator for the issues title.")
    description: Optional[NullableStringComparator] = Field(
...
class CommentFilter(BaseModel):
    ...
    body: Optional[StringComparator] = Field(None, description="Match on the comment's text.")
    created_at: Optional[DateComparator] = Field(
    ...
    user: Optional[UserFilter] = Field(None, description="Filter by who wrote the comment.")
...
class InitiativeFilter(BaseModel):
    ...
    status: Optional[StringComparator] = Field(
        None,
        description=(
            "Filter by status: 'Planned', 'Proposed', 'Active', 'Completed' or 'Canceled'."
        ),
    )
    creator: Optional[UserFilter] = Field(None, description="Filter by who created the initiative.")
    owner: Optional[UserFilter] = Field(None, description="Filter by the initiative's owner.")
    target_date: Optional[NullableDateComparator] = Field(
...
class DocumentFilter(BaseModel):
    ...
    slug_id: Optional[StringComparator] = Field(None, description="Filter by the document's slug.")
    creator: Optional[UserFilter] = Field(None, description="Filter by who created the document.")
    project: Optional[ProjectFilter] = Field(
...
class AttachmentFilter(BaseModel):
    ...
    title: Optional[StringComparator] = Field(None, description="Filter by title.")
    subtitle: Optional[NullableStringComparator] = Field(None, description="Filter by subtitle.")
    url: Optional[StringComparator] = Field(None, description="Filter by the attachment's URL.")
    source_type: Optional[StringComparator] = Field(
        None,
        description=(
            "Filter by which integration created the attachment, e.g. 'github' or 'slack'."
        ),
    )
    creator: Optional[UserFilter] = Field(None, description="Filter by who created the attachment.")
    created_at: Optional[DateComparator] = Field(
...
class CustomerFilter(BaseModel):
    ...
    owner: Optional[UserFilter] = Field(None, description="Filter by the customer's owner.")
    created_at: Optional[DateComparator] = Field(
...
class ProjectUpdateFilter(BaseModel):
    ...
    user: Optional[UserFilter] = Field(None, description="Filter by who posted the update.")
    project: Optional[ProjectFilter] = Field(
...
class ReleaseStageFilter(BaseModel):
    ...
    id: Optional[IdComparator] = Field(None, description="Comparator for the identifier.")
    name: Optional[StringComparator] = Field(None, description="Comparator for the stage name.")
...
class ReleasePipelineFilter(BaseModel):
    ...
    id: Optional[IdComparator] = Field(None, description="Comparator for the identifier.")
    name: Optional[StringComparator] = Field(None, description="Comparator for the pipeline name.")
...
class ReleaseFilter(BaseModel):
    ...
    id: Optional[IdComparator] = Field(None, description="Comparator for the identifier.")
    name: Optional[StringComparator] = Field(None, description="Comparator for the release name.")
    ...
    has_release_notes: Optional[BooleanComparator] = Field(
        None,
        description=(
            "Comparator for whether the release is covered by any (non-archived) release note."
        ),
    )
    created_at: Optional[DateComparator] = Field(
        None, description="Comparator for the created at date."
