...
class InitiativeCreateInput(BaseModel):
    ...
    description: Optional[str] = Field(None, description="The description of the initiative.")
    content: Optional[str] = Field(None, description="The initiative content as markdown.")
    status: Optional[InitiativeStatus] = Field(None, description="The status of the initiative.")
    ...
    color: Optional[str] = Field(None, description="The color of the initiative, as a hex string.")
...
class InitiativeUpdateInput(BaseModel):
    ...
    icon: Optional[str] = Field(None, description="The icon of the initiative.")
    color: Optional[str] = Field(None, description="The color of the initiative, as a hex string.")
    trashed: Optional[bool] = Field(None, description="Whether the initiative has been trashed.")
    sort_order: Optional[float] = Field(
        None, description="The sort order of the initiative within the workspace."
    )
    priority_sort_order: Optional[float] = Field(
