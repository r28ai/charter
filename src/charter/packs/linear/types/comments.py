...
class CommentCreateInput(BaseModel):
    ...
    issue_id: Optional[str] = Field(
        None, description="The issue to associate the comment with."
    )
    ...
    post_id: Optional[str] = Field(
        None, description="The post to associate the comment with."
    )
...
class CommentUpdateInput(BaseModel):
    ...
    body: Optional[str] = Field(
        None, description="The comment content in markdown format."
    )
    quoted_text: Optional[str] = Field(
        None, description="The text that this comment references."
    )
    resolving_user_id: Optional[str] = Field(
        None, description="The user who resolved the comment."
    )
...
class ReactionCreateInput(BaseModel):
    ...
    issue_id: Optional[str] = Field(
        None, description="The issue to associate the reaction with."
    )
    project_update_id: Optional[str] = Field(
