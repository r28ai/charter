...
class ProjectGetVariables(BaseModel):
    ...
    id: str = Field(
        ..., description="The project's UUID, or the slug from its URL."
    )
...
class ProjectCreateInput(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description="The description for the project."
    )
    content: Optional[str] = Field(
        None, description="The project content as markdown."
    )
    ...
    lead_id: Optional[str] = Field(
        None, description="The identifier of the project lead."
    )
    ...
    icon: Optional[str] = Field(
        None, description="The icon of the project."
    )
    color: Optional[str] = Field(
        None, description="The color of the project, as a hex string."
    )
...
class ProjectUpdateInput(BaseModel):
    ...
    trashed: Optional[bool] = Field(
        None, description="Whether the project has been trashed."
    )
    converted_from_issue_id: Optional[str] = Field(
...
class ProjectUpdateCreateInput(BaseModel):
    ...
    is_diff_hidden: Optional[bool] = Field(
        None, description="Whether the diff between the current update and the previous one is hidden."
    )
    id: Optional[str] = Field(
        None,
