...
class NotificationUpdateInput(BaseModel):
    ...
    read_at: Optional[str] = Field(
        None,
        description=(
            "The time at which the notification was marked as read, as an ISO 8601 timestamp."
        ),
    )
    snoozed_until_at: Optional[str] = Field(
        None,
        description=("The time until which the notification is snoozed, as an ISO 8601 timestamp."),
    )
...
class NotificationEntityInput(BaseModel):
    ...
    project_update_id: Optional[str] = Field(None, description="The id of the project update.")
...
class NotificationMarkReadAllVariables(BaseModel):
    ...
    input: NotificationEntityInput = Field(..., description="Whose notifications to mark as read.")
    read_at: str = Field(
        ...,
        description=(
...
class FavoriteCreateInput(BaseModel):
    ...
    folder_name: Optional[str] = Field(None, description="The name of a favorite folder to create.")
    ...
    facet_id: Optional[str] = Field(None, description="The identifier of the facet to favorite.")
...
class CustomViewCreateInput(BaseModel):
    ...
    description: Optional[str] = Field(None, description="The description of the custom view.")
    ...
    owner_id: Optional[str] = Field(None, description="The owner of the custom view.")
    ...
    color: Optional[str] = Field(None, description="The color of the icon, as a hex string.")
    initiative_id: Optional[str] = Field(
