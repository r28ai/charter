...
class CustomerCreateInput(BaseModel):
    ...
    domains: Optional[List[str]] = Field(
        None,
        description=(
            "The domains associated with the customer. Absent, Linear records "
            "none."
        ),
    )
    external_ids: Optional[List[str]] = Field(
        None,
        description=(
            "The ids of the customer in external systems. Absent, Linear records "
            "none."
        ),
    )
    ...
    status_id: Optional[str] = Field(
        None, description="The identifier of the customer's status."
    )
    tier_id: Optional[str] = Field(
        None, description="The identifier of the customer's tier."
    )
    revenue: Optional[int] = Field(
        None, description="The annual revenue associated with the customer."
    )
    size: Optional[int] = Field(
        None, description="The number of employees of the customer."
    )
    logo_url: Optional[str] = Field(
        None, description="The URL of the customer's logo."
    )
...
class CustomerNeedCreateInput(BaseModel):
    ...
    body: Optional[str] = Field(
        None, description="The content of the need in markdown format."
    )
    ...
    priority: Optional[float] = Field(
        None, description="The priority of the need."
    )
    ...
    def _one_way_of_naming_the_customer(self) -> CustomerNeedCreateInput:
        if self.customer_id is not None and self.customer_external_id is not None:
            raise ValueError(
                "Name the customer by `customer_id` or by `customer_external_id`, "
                "not both."
            )
        return self
