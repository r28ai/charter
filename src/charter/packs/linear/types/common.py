...
class StringComparator(BaseModel):
    ...
    not_ends_with: Optional[str] = Field(None, description="Does not end with the given string.")
...
class PageVariables(BaseModel):
    ...
    after: Optional[str] = Field(
        default=None,
        description=(
            "The `endCursor` from the previous page's `pageInfo`, to fetch the next page."
        ),
    )
...
class SlaStatusComparator(BaseModel):
    ...
    nin: Optional[List[SlaStatus]] = Field(None, description="Is not one of the given statuses.")
...
class CyclePeriodComparator(BaseModel):
    ...
    nin: Optional[List[CyclePeriod]] = Field(None, description="Is not one of the given periods.")
    null: Optional[bool] = Field(
...
class TeamVisibilityComparator(BaseModel):
    ...
    neq: Optional[TeamVisibility] = Field(None, description="Does not equal the given visibility.")
...
class SourceMetadataComparator(BaseModel):
    ...
    sub_type: Optional[SubTypeComparator] = Field(None, description="Comparator for the sub type.")
...
class ReleasePipelineTypeComparator(BaseModel):
    ...
    neq: Optional[ReleasePipelineType] = Field(None, description="Does not equal the given type.")
    in_: Optional[List[ReleasePipelineType]] = Field(None, description="Is one of the given types.")
...
class ReleaseStageTypeComparator(BaseModel):
    ...
    neq: Optional[ReleaseStageType] = Field(None, description="Does not equal the given type.")
    in_: Optional[List[ReleaseStageType]] = Field(None, description="Is one of the given types.")
