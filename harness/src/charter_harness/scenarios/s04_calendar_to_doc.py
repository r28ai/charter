...
class CalendarToDoc(Scenario):
    ...
    variants = {
        ...
        "five": {
            "events": [
                ...
                ("Budget sync", 14, 0),
                ("Standup", 9, 30),
                ("Lunch with Sam", 12, 30),
                ("Customer call", 11, 0),
            ]
        },
        "close_times": {
            "events": [("Third", 9, 30), ("First", 9, 0), ("Fourth", 9, 45), ("Second", 9, 15)]
        },
        "reverse_order": {
            "events": [
                ("Wrap-up", 17, 0),
    ...
    def wrong_observations(
        ...
        return [
            ...
            (
                "an event is missing",
                {"docs": [dict(doc, text="09:30 hx Standup\n14:00 hx Budget sync\n")]},
            ),
