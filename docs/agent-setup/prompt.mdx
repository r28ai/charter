...
Apache 2.0 licensed Python library for declaring agent tools as typed schemas,
with a deterministic runtime that handles auth, wire formats and field policy.
