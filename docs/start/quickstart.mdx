...
<Note>
The OpenAI format needs nothing beyond the core. LangChain needs `pip install 'charter[langchain]'`. Client configuration for the MCP server is on [its page](/using/mcp), and the other two on [adapters](/using/adapters).
</Note>
