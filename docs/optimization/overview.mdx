...
pack `comment_create` costs 911 tokens and `search_issues_full` costs 47,026, and
nothing about either name says so. Before that pack was narrowed, seventeen of its
tools sat within a few hundred tokens of each other at the top while the other 111
were under 1,800. Optimizing the wrong one of those is a day spent moving 911
tokens.
...
- [Measured results](/guarantees/measured-results): what these levers were worth across 534 runs
