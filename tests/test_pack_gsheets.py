    ...
    payload = {
        ...
        "properties": {
            ...
            "defaultFormat": {
                ...
                "textFormat": {"foregroundColor": {}, "fontFamily": "arial,sans,sans-serif",
                               "fontSize": 10, "bold": False, "italic": False},
            },
            "spreadsheetTheme": {
                "primaryFontFamily": "Arial",
                "themeColors": [{"colorType": t, "color": {"rgbColor": {"red": 0.1}}}
                                for t in ("TEXT", "BACKGROUND", "ACCENT1", "ACCENT2",
                                          "ACCENT3", "ACCENT4", "ACCENT5", "ACCENT6", "LINK")],
            },
        },
        "sheets": [{"properties": {
...
async def test_values_get_is_left_alone():
    ...
    payload = {"range": "Sheet1!A1:C3", "majorDimension": "ROWS",
...
async def test_values_clear_posts_an_empty_body():
    ...
    await gsheets.spreadsheets_values_clear.ainvoke(
        spreadsheet_id="s1", range="Sheet1!A1:C10"
    )
...
def test_the_preview_comment_surface_is_modelled():
    ...
    withheld = {
        entry["field"]
        for entry in egress_map(gsheets.TOOLS)["spreadsheets_create"]["withheld"]
    }
...
async def test_create_with_only_a_title_unwraps_the_spreadsheet():
    ...
    await gsheets.spreadsheets_create.ainvoke(
        spreadsheet={"properties": {"title": "Q3"}}
    )
