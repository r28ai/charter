...
def test_top_level_package_reexports_the_type_system():
    for name in (
        "Path", "Query", "Body", "Format", "Mode", "Case",
        "EmailContent", "DocumentContent", "FileContent",
        "Value", "ListValue", "Struct", "FieldMask",
        "CharterError", "CredentialError", "ToolValidationError",
